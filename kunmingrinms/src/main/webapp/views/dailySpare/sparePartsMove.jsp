	...
	<div id="content">
		<form class="form-horizontal" id="moveForm">
			<div style="margin-top:12px;">
				<span style="float:left; width:85px; margin-left:2px;">原机构备品信息</span>
			...
			<table class="popUpTable" >
				<tbody>
		            ...
		            <tr class="thTdPadding">
	            		...
	            		<td>
	            			<div>
			            		<input type="text" name="platesName" id="platesNameMove"  style="width:96%;height:30px" disabled="disabled">
	            			</div>
		            	</td>
	           			<th>所属工区</th>
	            		<td>
		            ...
		            <tr class="thTdPadding">
	          		...
	          		<tr class="thTdPadding">
		            	...
		            	<th>软件版本</th>
	           			<td colspan="3">
			            	<div>
			            		<input type="text" name="softwareVersionMove" id="softwareVersionMove"  style="width:96%;height:30px" disabled="disabled">
			            	</div>
		            	</td>
<!-- 	          			<th>现存数量</th> -->
<!-- 		            	<td> -->
		            ...
		            <tr class="thTdPadding">
		            	...
		            	<td>
	          			...
	          			<th>入库原因</th>
	           			<td >
	           			<div>
            				<input type="text" name="purchaseReasonMove" id="purchaseReasonMove" style="width:96%;height:30px" disabled="disabled">
		            	</div>
		            	</td>
		            </tr>
<!-- 	          		<tr class="thTdPadding"> -->
...
<!-- 	          		</tr> -->
			...
			<div style="margin-top:12px;">
				<span style="float:left; width:85px;margin-left:2px;">接收构备品信息</span>
				<hr style="float:left; width:520px;height:2px; background: #ccc;margin-top:8px;"></hr>
			</div>
...
<script type="text/javascript">
	...
	/**初始化弹出框开始*/
	$.post(contextPath + 'dailySpare/sparePartAction/getSparePartById.cn', //根据id查询备品
				{id : id},
...
// 		$("#specialityMove").val(dailySpare_speciality.typeName(result.speciality));
		$("#specialityMove").val(result.speciality);
...
// 		$("#unitMove").val(daily_unit.typeName(result.sparePartName.unit));
		...
		$("#platesNameMove").val(result.platesName);
