...
public class RecordAction {
    ...
    public Map<String,String> upload(@RequestParam(value = "files",required = false) MultipartFile[] multipartFiles,
        ...
        String day = dateStr.substring(7,9);
        
        String ym = currentDateStr.substring(0, 7);
        String[] ymArray = ym.split("-");
        
        ym = ymArray[0]+ymArray[1];
        
        document.put("ym", Integer.valueOf(ym));//年月
        document.put("dateStr", currentDateStr.substring(0, 10));//巡检打卡时间
