...
<body>
	...
	<script type="text/javascript">
		...
		if(ipAdress.indexOf("10.222")!=-1){
			url = 'http://10.222.139.2:7000/kmms/todoList/getTodoList';
			webSocketUrl = "ws://10.222.139.2:7001/socket/todoListSocket/";
		}else if(ipAdress.indexOf("172.23")!=-1){
			url =  'http://172.23.1.5:7000/kmms/todoList/getTodoList';
			webSocketUrl = "ws://172.23.1.5:7001/socket/todoListSocket/";
		}else{
			url = 'http://10.206.97.8:7000/kmms/todoList/getTodoList';
			webSocketUrl = "ws://10.206.97.8:7001/socket/todoListSocket/";
		}
...
//					url : 'http://10.206.97.8:7000/kmms/todoList/getTodoList',
// 	 				url : 'http://localhost:7000/kmms/todoList/getTodoList',
	 				url : 'http://'+window.location.hostname+':7000/kmms/todoList/getTodoList',
// 					url : url,
	 				proxy : {
	 					method : 'get',
	 					dataType : 'jsonp',
...
//			var webSocket = new WebSocket("ws://10.206.97.8:7001/socket/todoListSocket/"+loginUserId);
			var webSocket = new WebSocket("ws://"+window.location.hostname+":7001/socket/todoListSocket/"+loginUserId);
// 			var webSocket = new WebSocket(webSocketUrl+loginUserId);
			var msgRemind;
