define('views/commonjs/AddTraining',[
			...
			var form = new FormContainer({
				...
				formChildrens:[{
		    		...
		    		item:'<textarea id="org" style="width: 99.3%;height: 80px; resize:none" placeholder="请选择接收部门" data-rules="{required:true}" readonly="readonly"></textarea>'+
						...
						redStarFlag : false,
			    		itemColspan : 2,
			    		item:'<div id="uploadDiv"  style="overflow-y: hidden;overflow-x: hidden;width: 99.3%;"></div><input type="hidden" name="uploadFileArr" id="addUploadFileArr" />',
				}]
			});
				return form;
		},
