...
<!-- 		            </tr> -->
		            ...
		            <tr class="thTdPadding">
	            		...
	            		<td>
	            			<div>
			            		<input type="text" name="sparePartName" id="sparePartNameIn"  style="width:96%;height:30px" disabled="disabled">
	            			</div>
		            	</td>
	           			<th>所属工区</th>
	            		<td>
...
<!-- 		            	<td> -->
<!-- 			            	<div> -->
<!-- 			            		<input type="text" name="purchaseTimeIn" id="purchaseTimeIn" style="width:96%;height:30px" disabled="disabled"> -->
<!-- 			            	</div> -->
<!-- 		            	</td> -->
<!-- 		            	<th>入库时间</th> -->
<!-- 		            	<td> -->
...
<!-- 	           			<td colspan="3"> -->
<!-- 			            	<div> -->
<!-- 			            		<input type="text" name="purchaseReasonIn" id="purchaseReasonIn"  style="width:98%;height:30px" disabled="disabled"> -->
<!-- 			            	</div> -->
<!-- 		            	</td> -->
<!-- 		            </tr> -->
	          		<tr class="thTdPadding">
		            ...
		            <tr class="thTdPadding">
		            	...
		            	<td colspan="3">
		            		<div>
		            			<textarea name="comment" id="commentIn" style="width:98%;height:130px;resize:none"  disabled="disabled" ></textarea>
		            		</div>
		            	</td>
	          		</tr>
				</tbody>
...
<script type="text/javascript">
	...
	var inTips;
	var id= '${param.id}';
	var resultObj;//根据id查询的对象（应急备品）
	
	/**初始化弹出框开始*/
	$.post(contextPath + 'sparePartAction/getSparePartById.cn', //根据id查询设备名称（包含单位）
				{id : id},
...
// 		$("#specialityIn").val(emergency_speciality.typeName(result.speciality));
		$("#specialityIn").val(emergency_speciality_type.typeName(result.speciality));
// 		$("#sparePartNameIn").val(result.sparePartName.name);
		$("#sparePartNameIn").val(result.platesName);
...
// 		$("#unitIn").val(emergency_unit.typeName(result.sparePartName.unit));
		...
		$("#purchaseTimeIn").val(result.buyDate);
