...
public class DailySpareAndNormDTO implements Serializable {
	/** 达标*/
	...
	public String toString() {
		return "DailySpareAndNormDTO [speciality=" + speciality + ", deviceName=" + deviceName + ", deviceNameId="
				+ deviceNameId + ", workShop=" + workShop + ", workShopId=" + workShopId + ", amount=" + amount
				+ ", normValue=" + normValue + ", status=" + status + ", not_standard=" + not_standard
				+ ", deviceProperties=" + deviceProperties + ", factory=" + factory + ", availableModle="
				+ availableModle + ", singleNumber=" + singleNumber + ", platesName=" + platesName
