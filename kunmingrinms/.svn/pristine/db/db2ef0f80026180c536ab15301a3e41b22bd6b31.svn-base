...
<body style="overflow: hidden;">
	<form action="<%=contextPath%>/technicalRegulation/expTechnicalRegulation.cn" id="exportForm" method="post">
...
seajs.use("views/technical/technicalRegulationPage",function(TechnicalRegulationPage){
	var technicalRegulationPage = new TechnicalRegulationPage({
		contextPath : contextPath,
		perId : perId
	})
	technicalRegulationPage.render();
});
</script>
</body>
</html>