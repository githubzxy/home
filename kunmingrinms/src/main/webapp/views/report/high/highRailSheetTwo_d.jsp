...
<title>段高铁、城际铁路CIR故障统计及分析表</title>
...
<body>
<div style="margin-bottom:20px;margin-top:20px;line-height: 9px;">
	<label style="float:left;margin-top: 5px;margin-left: 20px;">车间：</label>
...
<table border=0 cellpadding=0 cellspacing=0 width=1066 style='border-collapse:
 ...
 <tr height=21 style='height:15.95pt'>
  ...
  <td colspan=34 class=xl9816718 style="white-space: normal;word-break:break-all;">${requestScope.belongDepartName}</td>
 </tr>
 <tr height=33 style='height:24.95pt'>
  <td rowspan=2 height=33 style='height:24.95pt;border-left:1pt solid windowtext' align=left>
  <span style='position:absolute;z-index:1;margin-left:0px;margin-top:1px;width:58px;
  height:166px'><img width=58 height=166
  src="/kunmingrinms/views/report/high/highRailSheetTwo1.files/wirelessWorkShopCir_8860_image001.png"></span><span
  style=''>
 ...
 <tr class="sheetOne" height=21 style='height:15.95pt'>
  ...
  <c:forEach items="${requestScope.resultA[0]}" var="item" begin="0" end="33">
 ...
 <tr class="sheetOne" height=21 style='height:15.95pt'>
  ...
  <td class=xl6516718 width=97 style='border-top:none;border-left:none;width:73pt' id="s12">天津712厂</td>
    <c:forEach items="${requestScope.resultA[1]}" var="item" begin="0" end="33">
  	<td class="xl6516718" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
 ...
 <tr class="sheetOne" height=21 style='height:15.95pt'>
  ...
  <td class=xl6516718 style='border-top:none;border-left:none;width:73pt' id="s13">上海通信工厂</td>
    <c:forEach items="${requestScope.resultA[2]}" var="item" begin="0" end="33">
  	<td class="xl6516718" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
 ...
 <tr class="sheetOne" height=21 style='height:15.95pt'>
  ...
  <td class=xl6516718 style='border-top:none;border-left:none;width:73pt' id="s14">北京希电公司</td>
    <c:forEach items="${requestScope.resultA[3]}" var="item" begin="0" end="33">
  	<td class="xl6516718" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
 ...
 <tr class="sheetOne" height=21 style='height:15.95pt'>
  ...
  <td class=xl6516718 width=97 style='border-top:none;border-left:none;width:73pt' id="s15">深圳长龙公司</td>
    <c:forEach items="${requestScope.resultA[4]}" var="item" begin="0" end="33">
  	<td class="xl6516718" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
 ...
 <tr class="sheetOne" height=21 style='height:15.95pt'>
  ...
  <td class=xl6516718 width=97 style='border-top:none;border-left:none;width:73pt' id="s16">杭州创联公司</td>
    <c:forEach items="${requestScope.resultA[5]}" var="item" begin="0" end="33">
  	<td class="xl6516718" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
 ...
 <tr class="sheetOne" height=21 style='height:15.95pt'>
  ...
  <c:forEach items="${requestScope.resultA[6]}" varStatus="i" var="item" begin="0" end="33">
  	<td class="xl6516718" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
 ...
 <tr class="sheetOne" height=21 style='height:15.95pt'>
  ...
  <td class=xl6516718 width=97 style='border-top:none;border-left:none;width:73pt' id="s18">上海复旦</td>
    <c:forEach items="${requestScope.resultA[7]}" var="item" begin="0" end="33">
  	<td class="xl6516718" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
 ...
 <tr class="sheetOne" height=21 style='height:15.95pt'>
  ...
  <td class=xl6516718 width=97 style='border-top:none;border-left:none;width:73pt' id="s19">河南辉煌</td>
    <c:forEach items="${requestScope.resultA[8]}" var="item" begin="0" end="33">
  	<td class="xl6516718" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
 ...
 <tr class="sheetOne" height=21 style='height:15.95pt'>
  ...
  <td class=xl6516718 width=97 style='border-top:none;border-left:none;width:73pt' id="s110">深圳思科泰</td>
    <c:forEach items="${requestScope.resultA[9]}" var="item" begin="0" end="33">
  	<td class="xl6516718" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
 ...
 <tr class="sheetOne" height=21 style='height:15.95pt'>
  ...
  <td class=xl6516718 width=97 style='border-top:none;border-left:none;width:73pt' id="s111">合计</td>
    <c:forEach items="${requestScope.resultA[10]}" varStatus="i" var="item" begin="0" end="33">
  	<td class="xl6516718" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
 ...
 <tr height=21 style='height:15.95pt'>
  <td colspan=3 rowspan=3 height=21 class=xl7316718 width=17 style='height:15.95pt;border-top:none;width:13pt'>
  	<img width=61 height=72 src="/kunmingrinms/views/report/high/highRailSheetTwo1.files/wirelessWorkShopCir_8860_image002.png">
  </td>
 ...
 <tr class="sheetTwo" height=21 style='height:15.95pt'>
  ...
  <td colspan=3 class="xl6516718" width=81 style='border-left:none;width:60pt'>${requestScope.resultB[0][0]}</td>
  <td colspan=3 class="xl6516718" width=81 style='border-left:none;width:60pt'>${requestScope.resultB[0][1]}</td>
  <td colspan=3 class="xl9216718" width=81 style='border-left:none;width:60pt'>${requestScope.resultB[0][2]}</td>
  <td colspan=3 class="xl9216718" width=81 style='border-left:none;width:60pt'>${requestScope.resultB[0][3]}</td>
  <td colspan=22 rowspan=11 class=xl92167181 width=594 style='width:440pt'>
  <textarea class="xl92167181" style="border:none;width:100%;height: 99%;resize: none;white-space: normal;" readonly="readonly">
	<c:if test="${not empty faultAnalysis}"><c:forEach items="faultAnalysis">${faultAnalysis }</c:forEach></c:if></textarea>
  </td>
 </tr>
 <tr class="sheetTwo" height=21 style='height:15.95pt'>
  <td colspan=3 height=21 class=xl6516718 width=51 style='height:15.95pt;width:39pt'>2</td>
  <td class=xl6516718 width=97 style='border-top:none;border-left:none;width:73pt' id="s22">天津712厂</td>
  <td colspan=3 class="xl6516718" width=81 style='border-left:none;width:60pt'>${requestScope.resultB[1][0]}</td>
  <td colspan=3 class="xl6516718" width=81 style='border-left:none;width:60pt'>${requestScope.resultB[1][1]}</td>
  <td colspan=3 class="xl9216718" width=81 style='border-left:none;width:60pt'>${requestScope.resultB[1][2]}</td>
  <td colspan=3 class="xl9216718" width=81 style='border-left:none;width:60pt'>${requestScope.resultB[1][3]}</td>
 </tr>
 <tr class="sheetTwo" height=21 style='height:15.95pt'>
  <td colspan=3 height=21 class=xl6516718 width=51 style='height:15.95pt;width:39pt'>3</td>
  <td class=xl6516718 width=97 style='border-top:none;border-left:none;width:73pt' id="s23">上海通信工厂</td>
  <td colspan=3 class="xl6516718" width=81 style='border-left:none;width:60pt'>${requestScope.resultB[2][0]}</td>
  <td colspan=3 class="xl6516718" width=81 style='border-left:none;width:60pt'>${requestScope.resultB[2][1]}</td>
  <td colspan=3 class="xl9216718" width=81 style='border-left:none;width:60pt'>${requestScope.resultB[2][2]}</td>
  <td colspan=3 class="xl9216718" width=81 style='border-left:none;width:60pt'>${requestScope.resultB[2][3]}</td>
 </tr>
 <tr class="sheetTwo" height=21 style='height:15.95pt'>
  <td colspan=3 height=21 class=xl6516718 width=51 style='height:15.95pt;width:39pt'>4</td>
  <td class=xl6516718 width=97 style='border-top:none;border-left:none;width:73pt' id="s24">北京希电公司</td>
  <td colspan=3 class="xl6516718" width=81 style='border-left:none;width:60pt'>${requestScope.resultB[3][0]}</td>
  <td colspan=3 class="xl6516718" width=81 style='border-left:none;width:60pt'>${requestScope.resultB[3][1]}</td>
  <td colspan=3 class="xl9216718" width=81 style='border-left:none;width:60pt'>${requestScope.resultB[3][2]}</td>
  <td colspan=3 class="xl9216718" width=81 style='border-left:none;width:60pt'>${requestScope.resultB[3][3]}</td>
 </tr>
 <tr class="sheetTwo" height=21 style='height:15.95pt'>
  <td colspan=3 height=21 class=xl6516718 width=51 style='height:15.95pt;width:39pt'>5</td>
  <td class=xl6516718 width=97 style='border-top:none;border-left:none;width:73pt' id="s25">深圳长龙公司</td>
  <td colspan=3 class="xl6516718" width=81 style='border-left:none;width:60pt'>${requestScope.resultB[4][0]}</td>
  <td colspan=3 class="xl6516718" width=81 style='border-left:none;width:60pt'>${requestScope.resultB[4][1]}</td>
  <td colspan=3 class="xl9216718" width=81 style='border-left:none;width:60pt'>${requestScope.resultB[4][2]}</td>
  <td colspan=3 class="xl9216718" width=81 style='border-left:none;width:60pt'>${requestScope.resultB[4][3]}</td>
 </tr>
 <tr class="sheetTwo" height=21 style='height:15.95pt'>
  <td colspan=3 height=21 class=xl6516718 width=51 style='height:15.95pt;width:39pt'>6</td>
  <td class=xl6516718 width=97 style='border-top:none;border-left:none;width:73pt' id="s26">杭州创联公司</td>
  <td colspan=3 class="xl6516718" width=81 style='border-left:none;width:60pt'>${requestScope.resultB[5][0]}</td>
  <td colspan=3 class="xl6516718" width=81 style='border-left:none;width:60pt'>${requestScope.resultB[5][1]}</td>
  <td colspan=3 class="xl9216718" width=81 style='border-left:none;width:60pt'>${requestScope.resultB[5][2]}</td>
  <td colspan=3 class="xl9216718" width=81 style='border-left:none;width:60pt'>${requestScope.resultB[5][3]}</td>
 </tr>
 <tr class="sheetTwo" height=21 style='height:15.95pt'>
  <td colspan=3 height=21 class=xl6516718 width=51 style='height:15.95pt;width:39pt'>7</td>
  <td class=xl6516718 width=97 style='border-top:none;border-left:none;width:73pt' id="s27">世纪东方</td>
  <td colspan=3 class="xl6516718" width=81 style='border-left:none;width:60pt'>${requestScope.resultB[6][0]}</td>
  <td colspan=3 class="xl6516718" width=81 style='border-left:none;width:60pt'>${requestScope.resultB[6][1]}</td>
  <td colspan=3 class="xl9216718" width=81 style='border-left:none;width:60pt'>${requestScope.resultB[6][2]}</td>
  <td colspan=3 class="xl9216718" width=81 style='border-left:none;width:60pt'>${requestScope.resultB[6][3]}</td>
 </tr>
 <tr class="sheetTwo" height=21 style='height:15.95pt'>
  <td colspan=3 height=21 class=xl6516718 width=51 style='height:15.95pt;width:39pt'>8</td>
  <td class=xl6516718 width=97 style='border-top:none;border-left:none;width:73pt' id="s28">上海复旦</td>
  <td colspan=3 class="xl6516718" width=81 style='border-left:none;width:60pt'>${requestScope.resultB[7][0]}</td>
  <td colspan=3 class="xl6516718" width=81 style='border-left:none;width:60pt'>${requestScope.resultB[7][1]}</td>
  <td colspan=3 class="xl9216718" width=81 style='border-left:none;width:60pt'>${requestScope.resultB[7][2]}</td>
  <td colspan=3 class="xl9216718" width=81 style='border-left:none;width:60pt'>${requestScope.resultB[7][3]}</td>
 </tr>
 <tr class="sheetTwo" height=21 style='height:15.95pt'>
  <td colspan=3 height=21 class=xl6516718 width=51 style='height:15.95pt;width:39pt'>9</td>
  <td class=xl6516718 width=97 style='border-top:none;border-left:none;width:73pt' id="s29">河南辉煌</td>
  <td colspan=3 class="xl6516718" width=81 style='border-left:none;width:60pt'>${requestScope.resultB[8][0]}</td>
  <td colspan=3 class="xl6516718" width=81 style='border-left:none;width:60pt'>${requestScope.resultB[8][1]}</td>
  <td colspan=3 class="xl9216718" width=81 style='border-left:none;width:60pt'>${requestScope.resultB[8][2]}</td>
  <td colspan=3 class="xl9216718" width=81 style='border-left:none;width:60pt'>${requestScope.resultB[8][3]}</td>
 </tr>
 <tr class="sheetTwo" height=21 style='height:15.95pt'>
  <td colspan=3 height=21 class=xl6516718 width=51 style='height:15.95pt;width:39pt'>10</td>
  <td class=xl6516718 width=97 style='border-top:none;border-left:none;width:73pt' id="s210">深圳思科泰</td>
  <td colspan=3 class="xl6516718" width=81 style='border-left:none;width:60pt'>${requestScope.resultB[9][0]}</td>
  <td colspan=3 class="xl6516718" width=81 style='border-left:none;width:60pt'>${requestScope.resultB[9][1]}</td>
  <td colspan=3 class="xl9216718" width=81 style='border-left:none;width:60pt'>${requestScope.resultB[9][2]}</td>
  <td colspan=3 class="xl9216718" width=81 style='border-left:none;width:60pt'>${requestScope.resultB[9][3]}</td>
 </tr>
 <tr class="sheetTwo" height=21 style='height:15.95pt'>
  ...
  <td colspan=3 class="xl6516718" width=81 style='border-left:none;width:60pt'>${requestScope.resultB[10][0]}</td>
  <td colspan=3 class="xl6516718" width=81 style='border-left:none;width:60pt'>${requestScope.resultB[10][1]}</td>
  <td colspan=3 class="xl9216718" width=81 style='border-left:none;width:60pt'>${requestScope.resultB[10][2]}</td>
  <td colspan=3 class="xl9216718" width=81 style='border-left:none;width:60pt'>${requestScope.resultB[10][3]}</td>
 </tr>
 <tr style='height:30px'>
  <td colspan=4 height=21 class=xl8916718 style='height:15.95pt'></td>
  <td colspan=3 class="xl9116718"></td>
  <td class=xl7016718 width=27 style='border-top:none;width:20pt'></td>
  <td class=xl7116718 width=27 style='width:20pt'></td>
  <td colspan=3 class=xl8916718></td>
  <td colspan=4 class="xl9116718"></td>
  <td class=xl7016718 width=27 style='border-top:none;width:20pt'></td>
  <td class=xl7216718></td>
  <td colspan=4 class=xl8916718></td>
  <td colspan=4 class="xl9116718"></td>
  <td class=xl7216718></td>
  <td class=xl7116718 width=27 style='width:20pt'></td>
  <td width=27 style='width:20pt' align=left></td>
  <td colspan=4 class=xl8916718></td>
  <td colspan=4 class=xl9016718></td>
  <td class=xl7216718></td>
 </tr>
</table>
</div>
...
BUI.use(['bui/data', 'bui/select'], function(Data, Select) {
	var store = new Data.Store({
		autoLoad : true,
		proxy : {
			url : contextPath + "highRailSheetTwoAction/getReportWorkshop.cn",
			method : 'post'
		},
		params : {
			year : $("#year").val(),
	...
	$("#searchBtn").click(function() {
		$("#showForm").attr("action", "/kunmingrinms/highRailSheetTwoAction/getHighRailSheetTwoBycj.cn");
		$("#showForm").submit();
	});
	
	//导出Excel
	$("#exportBtn").click(function() {
		$("#showForm").attr("action", "/kunmingrinms/highRailSheetTwoAction/exportShowBycj.cn");
		$("#showForm").submit();
	});
