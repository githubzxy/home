 ...
 * @author zsh
 */
define('views/msgRemind/MsgList',
		['bui/common', 'bui/list'],
		function(require){
	...
	var ITEM_TPL = '<li class="bui-list-item {handleCls}" style="height: 22px;color: #333333; cursor: pointer; box-shadow: 0 0 1px #999999 inset; padding: 4px;">'
		+ '<span style="float: left; line-height:1; padding: 5.5px 7px; color: #428bca; ">{text}</span><span class="badge badge-error" style="padding: 1px 6px; position: relative; left: -5px; top: -5px;">{count}</span><span class="x-icon x-icon-small x-icon-info" style="float: right; position: relative; top: 4px;"><i class="icon icon-white {handleIconCls}"></i></span>'
		+ '</li>';
