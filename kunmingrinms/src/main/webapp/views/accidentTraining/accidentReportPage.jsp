...
<script type="text/javascript">
	...
	var dialogTitle='事故演练计划';
	/* 路径区 */
	var pathForPage='accidentAction/getAllAccidentDataByUser.cn';//主页面路径
	var pathForQueryPlan='accidentAction/getAccidentById.cn';//查询计划
	var pathForQueryReport='accidentAction/getAccidentShopByAccidentId.cn';//查询汇报计划
	var pathForSaveReportPlan='accidentAction/updateAccidentShopData.cn';//保存汇报计划
	seajs.config({
		paths:{
