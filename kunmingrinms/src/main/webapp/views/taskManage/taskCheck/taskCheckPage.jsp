...
<body style="overflow: hidden;">
	...
	<form action="/kunmingrinms/taskRootAction/expTaskRoot.cn" id="exportForm" method="post">
		...
		<input type="hidden" value="任务审核" name="fileName">
	</form>
...
// 			showTime : true,
		...
		store = new Data.Store({
			url : contextPath+'taskRootAction/getCheckByDTO.cn',
			pageSize : 10,
			proxy : {
				method : 'post',
				dataType : 'json'
		...
		function handleDialogCreate(id,taskStatus){
	    	   handleDialog = new Overlay.Dialog({
					...
					loader : {
						url : contextPath + 'views/taskManage/taskCheck/taskCheckDetail.jsp?id='+id+'&taskStatus='+taskStatus,
