...
<table border=0 cellpadding=0 cellspacing=0 width=1500 class=xl979609
 ...
 <tr height=20 style='height:15.0pt' class="trClass">
  ...
  <td class="xl1029609 editCell" style='border-top:none;border-left:none;'>${item.date }</td>
  <td class="xl1029609 editCell" style='border-top:none;border-left:none;'>${item.station }</td>
  <td class="xl1029609 editCell" style='border-top:none;border-left:none;'>${item.equipmentName }</td>
  <td class="xl1029609 editCell" style='border-top:none;border-left:none;'>${item.identifier }</td>
  <td class="xl1029609 editCell" style='border-top:none;border-left:none;'>${item.faultPhenomenon }</td>
  <td class="xl1029609 editCell numberCell" style='border-top:none;border-left:none'>${item.radioHost }</td>
  <td class="xl1029609 editCell numberCell" style='border-top:none;border-left:none'>${item.controlBox }</td>
  <td class="xl1029609 editCell numberCell" style='border-top:none;border-left:none'>${item.controlCable }</td>
  <td class="xl1029609 editCell numberCell" style='border-top:none;border-left:none'>${item.aerial }</td>
  <td class="xl1029609 editCell numberCell" style='border-top:none;border-left:none'>${item.adaptor }</td>
  <td class="xl1029609 editCell numberCell" style='border-top:none;border-left:none'>${item.decoder }</td>
  <td class="xl1029609 editCell numberCell" style='border-top:none;border-left:none'>${item.record }</td>
  <td class="xl1029609 editCell numberCell" style='border-top:none;border-left:none'>${item.testWell }</td>
  <td class="xl1029609 editCell" style='border-top:none;border-left:none;'>${item.testFixNote }</td>
  <td class="xl1029609 editCell" style='border-top:none;border-left:none;'>${item.remark }</td>
  <td class="xl1029609" style='border-top:none;border-left:none'>
  	<a class="addRow" href="#" onclick="add_line('${s.count}')" id="row${s.count}">增加</a><c:if test="${s.count gt 1}">&nbsp;<a class="delRow" href="#" onclick="remove_line(this)">删除</a></c:if></td>
 </tr>
 </c:forEach>
 <tr height=40 style='height:30.0pt'>
  <td rowspan=2 height=60 class=xl1009609 width=49 style='height:45.0pt;
 ...
 <tr height=20 style='height:15.0pt' id="total">
  ...
  <c:forEach items="${sumResult}" var="item" varStatus="s">
  	<td class="xl1029609 sum${s.count}" style='border-top:none;border-left:none'>${item }</td>
  </c:forEach>
  <td class=xl1029609 style='border-top:none;border-left:none'></td>
  <td class=xl1029609 style='border-top:none;border-left:none'></td>
  <td class="xl1029609" style='border-top:none;border-left:none'>
<!--   	<a class="sumRow" href="#" id="sum">计算合计</a> -->
 ...
 <tr height=19 style='height:14.25pt'>
  ...
  <td colspan=2 class="xl1049609 fillEditCell" style='border-top:none;' id="reporter">${requestScope.list[0].userId }</td>
...
function getSumData(){
	...
	$('.sum1').html(radioHost);
	$('.sum2').html(controlBox);
	$('.sum3').html(controlCable);
	$('.sum4').html(aerial);
	$('.sum5').html(adaptor);
	$('.sum6').html(decoder);
	$('.sum7').html(record);
		...
		$.post(contextPath + 'wirelessDeviceSheetEightAction/add.cn',
				{
					...
					if(status){
						$("#updateForm").attr("action", "/kunmingrinms/wirelessDeviceSheetEightAction/exportShow.cn");
						$("#updateForm").submit();
					}else{
						alert("导出失败!");
					}
