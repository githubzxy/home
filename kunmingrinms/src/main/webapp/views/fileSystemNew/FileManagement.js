 ...
 * 文件管理主页面模块
 */
define('views/fileSystemNew/FileManagement',['bui/common',
	'bui/data','bui/grid','bui/calendar',
	'common/org/OrganizationPicker',
	'common/grid/SearchGridContainer',
	'common/data/PostLoad',
	'views/fileSystemNew/FileManagementAdd',
	'views/fileSystemNew/FileManagementUpdate',
	'views/fileSystemNew/FileManagementDetails'],function(require){
	var BUI = require('bui/common'),
		...
		FileManagementAdd = require('views/fileSystemNew/FileManagementAdd'),
		FileManagementUpdate = require('views/fileSystemNew/FileManagementUpdate'),
		FileManagementDetails = require('views/fileSystemNew/FileManagementDetails');
					...
					if(selections.length != 0){
						...
						BUI.Message.Confirm('确认要删除么？',function(){
							var postLoad =new PostLoad({
								url:contextPath + 'fileSystemNewAction/delRecord.cn',
								loadMsg:''
							});
							data = {ids: fileIds};
...
//				console.log(data);
			...
			/*_exportXls:function(){
				...
				var postLoad = new PostLoad({
					url : contextPath + 'fileSystemNewAction/exportXls.cn',
					el : '#fileManage',
					loadMsg : '导出中...'
				}); 
			...
			_initFileType:function(){
				fileSystem_fileType.listData("#fileType");
			},
			/**
			 * 表格列名
			 */
				...
				var columns = [
					{
						...
						renderer:function(value,obj) {
							return fileSystem_fileType.typeName(value);
						}
					},
					{
						title:'所属部门',
			...
			_initStore: function(){
				...
				var store = new Data.Store({
					url: contextPath + 'fileSystemNewAction/getData.cn',
					autoLoad: true,
					pageSize: 10,
					proxy: {
						method: 'post',
