...
<table border=0 cellpadding=0 cellspacing=0 
 ...
 <tr style='height:18.75pt'>
  ...
  <c:forEach items="${requestScope.result[0]}" varStatus="i" var="item" begin="0" end="58">
  	<td class="xl7716225 editCell" style='border-left:none'>${item}</td>
  </c:forEach>
 </tr>
 <tr style='height:18.75pt'>
 ...
 <tr class=xl6553516225  style='height:20.1pt'>
  ...
  <td colspan = 2 class="xl6553516225 fillEditCell" style='text-align:left; white-space: normal;' id="principal">${requestScope.result[0][61]}</td>
  <td class=xl6553516225></td>
  <td class=xl6553516225></td>
  <td class=xl6553516225></td>
  <td class=xl6553516225></td>
  ...
  <td colspan=3 class="xl6553516225 fillEditCell" style='text-align:left; white-space: normal;' id="phone">${requestScope.result[0][65]}</td>
  <td class=xl6553516225></td>
  <td class=xl6553516225></td>
 </tr>
	...
	$.post(contextPath + 'wiredMonthFaultAction/addOrUpdate.cn',
			{
				...
				if(status){
					$("#updateForm").attr("action", "/kunmingrinms/wiredMonthFaultAction/exportWorkShop.cn");
					$("#updateForm").submit();
				}else{
					alert("保存失败!");
				}
