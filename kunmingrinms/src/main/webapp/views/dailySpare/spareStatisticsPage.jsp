...
<body style="overflow: hidden;">
		...
		<fieldset>
			...
			<div class="row">
				<div class="control-group span8">
					...
					<div class="controls">
						<input type="text" id="workShops" class="input-normal" style="width: 171px;" autocomplete="off" />
	...
	<form action="/kunmingrinms/dailySpare/sparePartAction/expSpareStatistics.cn" id="exportForm" method="post">
...
// 	}
	...
	columns = [{
			...
			width:50,
			renderer:function(value){
// 				return daily_unit.typeName(value);
		...
		function loadData(){
			...
			/*
			 *当页面上的车间名称存在时,车间id为$("#workShop").val()
			 *			     不存在时,车间id为""
			 */
			$("#workShops").val()?workShopId=$("#workShop").val():workShopId="";
...
// 			console.log(areaArr);
			...
			store = new Data.Store({
				url : contextPath+'dailySpare/sparePartAction/getAreaSpareStatisticsByShop.cn',
				proxy : {
					method : 'post',
					dataType : 'json'
				},
				...
				dialog = new Overlay.Dialog({
					...
					closeAction : 'destroy',//关闭时销毁加载到主页面的HTML对象
	   				...
	   				buttons : [ {
						...
						handler :function(){
							window.location.href=contextPath+'dailySpare/sparePartAction/exportShop.cn';
...
// 							tableExportToExcel("expExcelOfShop",fileName, sheetName,tableContent);
					...
					loader : {
						url : contextPath +  'views/dailySpare/spareStatisticsOfAllShop.jsp',
	...
	function exportXls(){
        ...
        if(workShop){
		window.location.href=contextPath+'dailySpare/sparePartAction/exportArea.cn?workShopId='+$('#workShop').val();
        }else{
            window.location.href=contextPath+'dailySpare/sparePartAction/exportShop.cn'
        }
	}
