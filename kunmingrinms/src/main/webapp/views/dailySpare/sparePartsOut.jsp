			...
			<table class="popUpTable">
				<tbody>
		            ...
		            <tr class="thTdPadding">
	            		...
	            		<td>
	            			<div>
			            		<input type="text" name="platesName" id="platesNameOut"  style="width:96%;height:30px" disabled="disabled">
	            			</div>
		            	</td>
	           			<th>所属工区</th>
	            		<td>
...
<!-- 		            	</td> -->
		             ...
		             <tr class="thTdPadding">
		            	...
		            	<td>
	          			...
	          			<th>入库原因</th>
	           			<td >
			            	<div>
			            		<input type="text" name="purchaseReasonOut" id="purchaseReasonOut"  style="width:96%;height:30px" disabled="disabled">
			            	</div>
		            	</td>
		            </tr>
	          		<tr class="thTdPadding">
		            ...
		            <tr class="thTdPadding">
		            	...
		            	<td colspan="3">
		            		<div>
		            			<textarea name="rearon" id="rearonOut" style="width:98%;height:100px;" data-rules="{maxlength:200}"></textarea>
		            		</div>
		            	</td>
	          		</tr>
				</tbody>
...
// 		$("#specialityOut").val(dailySpare_speciality.typeName(result.speciality));
		$("#specialityOut").val(result.speciality);
...
// 		$("#unitOut").val(daily_unit.typeName(result.sparePartName.unit));
		...
		$("#platesNameOut").val(result.platesName);
