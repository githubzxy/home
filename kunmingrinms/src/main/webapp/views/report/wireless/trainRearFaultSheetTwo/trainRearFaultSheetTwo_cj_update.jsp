...
<table border=0 cellpadding=0 cellspacing=0 style='border-collapse:
 ...
 <tr height=33 style='height:24.95pt' class="trClass">
  ...
  width:64pt'>${item.date}</td>
  <td class="xl10310009 editCell" width=85 style='border-top:none;border-left:none;
  width:64pt'>${item.time}</td>
  <td class="xl10110009 editCell" width=85 style='border-top:none;border-left:none;
  width:64pt'>${item.acceptPerson}</td>
  <td class="xl10110009 editCell" width=85 style='border-top:none;border-left:none;
  width:64pt'>${item.trainType}</td>
  <td class="xl10110009 editCell" width=85 style='border-top:none;border-left:none;
  width:64pt'>${item.controlBox}</td>
  <td class="xl10210009 editCell" width=85 style='border-top:none;border-left:none;
  width:64pt'>${item.faultControlBox}</td>
  <td class="xl10110009 editCell" width=85 style='border-top:none;border-left:none;
  width:64pt'>${item.faultPhenomenon}</td>
  <td class="xl10110009 editCell" width=85 style='border-top:none;border-left:none;
  width:64pt'>${item.enterDate}</td>
  <td class="xl10310009 editCell" width=85 style='border-top:none;border-left:none;
  width:64pt'>${item.enterTime}</td>
  <td class="xl10110009 editCell" width=85 style='border-top:none;border-left:none;
  width:64pt'>${item.deviceExamine}</td>
  <td class="xl10110009 editCell" width=85 style='border-top:none;border-left:none;
  width:64pt'>${item.dealFault}</td>
  <td class="xl10110009 editCell" width=85 style='border-top:none;border-left:none;
  width:64pt'>${item.upAndDown}</td>
  <td class="xl10110009 editCell" width=117 style='border-top:none;border-left:none;
  width:88pt'>${item.faultBoxNum}</td>
  <td class="xl10110009 editCell" width=117 style='border-top:none;border-left:none;
  width:88pt'>${item.changeFaultBoxNum}</td>
  <td class="xl10110009 editCell" width=85 style='border-top:none;border-left:none;
  width:64pt'>${item.repairPerson}</td>
  <td class="xl10110009 editCell" width=85 style='border-top:none;border-left:none;
  width:64pt'>${item.memo}</td>
 ...
 <tr height=35 style='height:26.25pt' id="endLine">
  ...
  <td colspan=2 class="xl11310009 fillEditCell" id="phone">${requestScope.list[0].phone }</td>
  <td class=xl10710009 style='border-top:none'></td>
...
//点击保存按钮
$('#updateDiv #saveBtn').on('click',function(){
	// 长度校验
...
// 数据保存
function saveData(){
	var trainRearFaultSheetTwos = getSaveDate();
	...
	$.post(contextPath + 'trainRearFaultAction/add.cn',
			{
				...
				if(status){
					$("#updateForm").attr("action", "/kunmingrinms/trainRearFaultAction/exportShow.cn");
					$("#updateForm").submit();
				}else{
					alert("导出失败!");
				}
