 ...
 * 备品审核主页模块
 */
define('views/emergency/SpareAuditPage',[
								'bui/common','bui/data','bui/grid',
								'common/grid/SearchGridContainer',
								'common/org/OrgTreePicker',
								'views/emergency/SpareUserSituation',
								],function(require){
	...
	SpareUserSituation = require('views/emergency/SpareUserSituation'),
	...
	var SpareAuditPage = Component.Controller.extend({
				          ...
				          buttons : [
				            {
				              ...
				              handler : function(){
				      			...
				      			$.post(contextPath + 'sparePartAction/auditSparePass.cn', 
				  						{
				  							ids : ids
				  						},
				            ...
				            },
				            {
				              ...
				              handler : function(){
					      			...
					      			$.post(contextPath + 'sparePartAction/auditSpareNoPass.cn', 
					  						{
					  							ids : ids
					  						},
					  						function(result,status){
		...
		_initSearchFormAutoFilling : function(){
			...
			emergency_speciality.listData("#speciality");// 设备类别
			emergency_attribute.listData("#deviceProperties");// 设备属性
