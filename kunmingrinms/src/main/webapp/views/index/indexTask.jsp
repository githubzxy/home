...
<!--                     </li> -->
        ...
        <div class="big-table">
			<div class="module_title">
				<span class="title"><a href="<%=contextPath%>/index.jsp">首页</a>/临时任务通知</span>
...
BUI.use(['bui/calendar','bui/list','bui/data','bui/toolbar'],function(Calendar,List,Data,Toolbar){
	...
	var listTpl = '<li>[{createDate}]<a href="'+contextPath+'homeAction/showMessageOfTask.cn?id={docId}" target="_self">{taskName}</a></li>';
	store = new Data.Store({
		url: contextPath+'homeAction/getHomeTaskList.cn',
		proxy : {
			method : 'post',
			dataType : 'json'
		},
