...
<body style="overflow: hidden;">
	...
	<div class="search-grid-container">
		<fieldset>
			...
			<div id="miniSquareSpace">
				...
				<span class="miniSquare" style="background-color: #333333"></span>已接收
	...
	<form action="/kunmingrinms/dispatchRootAction/expAllDispatchRoot.cn" id="exportForm" method="post">
...
// 		}));
		...
		//  数据库取出路局管理数据	
		store = new Store({
			url : contextPath + "dispatchRootAction/getAllDispatchRootQuery.cn",
			pageSize : pageSize,
			proxy : {
				method : 'post',
				dataType : 'json',
		...
		grid = new GB({
			...
			itemStatusFields : {
				...
				red : 'chulizhong',
				blue : 'yiguidang',
				yiChaoQi: 'yiChaoQi'//如果isOverTime : true,则附加 bui-grid-row-read 样式（红色字体）
			},
			tbar : {
				items : [{
