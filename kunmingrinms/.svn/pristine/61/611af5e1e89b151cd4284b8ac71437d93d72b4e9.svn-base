...
<body style="overflow: hidden;">
    ...
    <form action="/kunmingrinms/toDoCircuitWOAction/expToDoByWorkShopDirector.cn" id="exportForm" method="post">
...
//      }));
        ...
        store = new Data.Store({
            url : contextPath + 'toDoCircuitWOAction/getToDoByWorkShopDirector.cn',
            pageSize : 10,
            proxy : {
                method : 'post',
                dataType : 'json'
