...
<body>
<div style="margin-bottom:40px;margin-top:20px;margin-left:0px">
...
<table border=0 cellpadding=0 cellspacing=0 
 ...
 <tr class=xl6553516225 style='height:13.5pt'>
  ...
  <td class=xl6553516225 style = "text-align:left; vertical-align:middle; white-space:normal;" colspan=55 id="belongOrgName">${requestScope.belongDepartName}</td>
  <td class=xl6553516225></td>
 ...
 <tr style='height:20.25pt'>
  ...
  src="/kunmingrinms/views/report/wired/wiredMonthFault/wiredMonthFault.files/image001.png"></td>
...
BUI.use(['bui/data', 'bui/select'], function(Data, Select) {
	var store = new Data.Store({
		autoLoad : true,
		proxy : {
			url : contextPath + "wiredMonthFaultAction/getReportWorkshop.cn",
			method : 'post'
		},
		params : {
			year : $("#year").val(),
...
$("#searchBtn").click(function() {
	$("#showForm").attr("action", "/kunmingrinms/wiredMonthFaultAction/getSegmentByDto.cn");
	$("#showForm").submit();
});

//导出Excel
$("#exportBtn").click(function() {
	$("#showForm").attr("action", "/kunmingrinms/wiredMonthFaultAction/exportSegment.cn");
	$("#showForm").submit();
});
</script>
</body>
