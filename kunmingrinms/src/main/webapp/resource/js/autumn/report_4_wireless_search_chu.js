// 说明：report_4_wireless_search_chu.js与report_4_wireless_search.js一样
//全局变量
var store;
var tree;
var picker;
...
BUI.use(['bui/extensions/treepicker','bui/tree','bui/data'],function(TreePicker,Tree,Data){
	store = new Data.TreeStore({
		...
		params : {         //设置请求时的参数
			...
			year:$("#year").html(),
			report:"2",//类型，1-通无报4，2-通无报5，3-灾报4
			orgId:$("#orgId").val()
		},
		dataProperty : 'data',
		proxy : {
...
function getTable1(){
	$.ajax({
		type: "POST",
		url: "/kunmingrinms/DeviceCollectionWireless?method=queryAllForSearch",
		dataType: "json",
		data: {
			"year":$("#year").html(),
...
function exportTable(){
	var url = "/kunmingrinms/DeviceCollectionWireless?method=exportForSearch";
	url += "&year="+$("#year").html();
	url += "&orgId="+$("#orgId").val();
