...
<!-- 		            </tr> -->
		            ...
		            <tr class="thTdPadding">
	            		...
	            		<td>
	            			<div>
			            		<input type="text" name="sparePartName" id="sparePartNameEdit" style="width:96%;height:30px" disabled="disabled">
		            	...
		            	<td>
			            	<div>
			            		<input type="text" name="amount" id=amountEdit 
			            							data-rules="{required:true,regexp:[/^\d+$/,'必须为数字'],maxlength:50}"  style="width:96%;height:30px">
			            	</div>
		            	</td>
	          		</tr>
	          		<tr class="thTdPadding">
...
<!-- 		            	<td> -->
<!-- 			            	<div> -->
<!-- 			            		<input type="text" name="purchaseTimeEdit" id="purchaseTimeEdit" style="width:96%;height:30px" disabled="disabled"> -->
<!-- 			            	</div> -->
<!-- 		            	</td> -->
<!-- 		            	<th>入库时间</th> -->
<!-- 		            	<td> -->
...
<!-- 	           			<td colspan="3"> -->
<!-- 			            	<div> -->
<!-- 			            		<input type="text" name="purchaseReasonEdit" id="purchaseReasonEdit" style="width:98%;height:30px" disabled="disabled"> -->
<!-- 			            	</div> -->
<!-- 		            	</td> -->
<!-- 		            </tr> -->
		            <tr class="thTdPadding">
		            ...
		            <tr class="thTdPadding">
		            	...
		            	<td colspan="3">
		            		<div>
		            			<textarea name="comment" id="commentEdit" style="width:98%;height:130px;" data-rules="{maxlength:200}"></textarea>
		            		</div>
		            	</td>
	          		</tr>
				</tbody>
...
// 		$("#specialityEdit").val(emergency_speciality.typeName(result.speciality));
		$("#specialityEdit").val(emergency_speciality_type.typeName(result.speciality));
// 		$("#sparePartNameEdit").val(result.sparePartName.name);
		$("#sparePartNameEdit").val(result.platesName);
...
// 		$("#unitEdit").val(emergency_unit.typeName(result.sparePartName.unit));
...
// 		$("#sparePartNameEdit_hidden").val(result.sparePartName.id);
		$("#sparePartNameEdit_hidden").val(result.platesName);
...
// 		 	 deviceNameId : $("#sparePartNameEdit_hidden").val(),
		 	 platesName : $("#sparePartNameEdit_hidden").val(),
