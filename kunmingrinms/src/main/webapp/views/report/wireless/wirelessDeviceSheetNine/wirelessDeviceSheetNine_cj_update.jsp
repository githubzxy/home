...
<table border=0 cellpadding=0 cellspacing=0 width=1210 class=xl9723099
 ...
 <tr height=20 style='height:15.0pt' class="trClass">
  ...
  <td class="xl10223099 editCell" style='border-top:none;border-left:none;'>${item.date }</td>
  <td class="xl10223099 editCell" style='border-top:none;border-left:none;'>${item.interregional }</td>
  <td class="xl10223099 editCell" style='border-top:none;border-left:none;'>${item.equipmentName }</td>
  <td class="xl10223099 editCell" style='border-top:none;border-left:none;'>${item.identifier }</td>
  <td class="xl10223099 editCell" style='border-top:none;border-left:none;'>${item.faultPhenomenon }</td>
  <td class="xl10223099 editCell numberCell" style='border-top:none;border-left:none'>${item.positiveplate }</td>
  <td class="xl10223099 editCell numberCell" style='border-top:none;border-left:none'>${item.reversedisc }</td>
  <td class="xl10223099 editCell numberCell" style='border-top:none;border-left:none'>${item.duplexer }</td>
  <td class="xl10223099 editCell numberCell" style='border-top:none;border-left:none'>${item.power }</td>
  <td class="xl10223099 editCell numberCell" style='border-top:none;border-left:none'>${item.aerial }</td>
  <td class="xl10223099 editCell numberCell" style='border-top:none;border-left:none'>${item.leakycable }</td>
  <td class="xl10223099 editCell numberCell" style='border-top:none;border-left:none'>${item.repeater }</td>
  <td class="xl10223099 editCell numberCell" style='border-top:none;border-left:none'>${item.intervalstation }</td>
  <td class="xl10223099 editCell numberCell" style='border-top:none;border-left:none'>${item.opticalpowercable }</td>
  <td class="xl10223099 editCell numberCell" style='border-top:none;border-left:none'>${item.testWell }</td>
  <td class="xl10223099 editCell" style='border-top:none;border-left:none;'>${item.testFixNote }</td>
  <td class="xl10223099 editCell" style='border-top:none;border-left:none;'>${item.remark }</td>
 ...
 <tr height=20 style='height:15.0pt'>
  ...
  <td class="xl10223099 sum${s.count}" style='border-top:none;border-left:none'>${item }</td>
  </c:forEach>
  <td class=xl10223099 style='border-top:none;border-left:none'></td>
  <td class=xl10223099 style='border-top:none;border-left:none'></td>
  <td class="xl10223099" style='border-top:none;border-left:none'>
<!--   	<a class="sumRow" href="#" id="sum">计算合计</a> -->
 ...
 <tr height=20 style='height:15.0pt'>
  ...
  <td colspan=2 class="xl10123099 fillEditCell" style='border-top:none;' id="reporter">${requestScope.list[0].userId }</td>
...
function getSumData(){
	...
	$('.sum1').html(positiveplate);
	$('.sum2').html(reversedisc);
	$('.sum3').html(duplexer);
	$('.sum4').html(power);
	$('.sum5').html(aerial);
	$('.sum6').html(leakycable);
	$('.sum7').html(repeater);
	$('.sum8').html(intervalstation);
	$('.sum9').html(opticalpowercable);
	$('.sum10').html(testWell);
};
// 若为空,则转换为0
		...
		$.post(contextPath + 'wirelessDeviceSheetNineAction/add.cn',
				{
					...
					if(status){
						$("#updateForm").attr("action", "/kunmingrinms/wirelessDeviceSheetNineAction/exportShow.cn");
						$("#updateForm").submit();
					}else{
						alert("导出失败!");
					}
