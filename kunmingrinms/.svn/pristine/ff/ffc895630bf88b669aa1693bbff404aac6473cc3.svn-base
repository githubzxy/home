			...
			<table class="popUpTable">
				<tbody>
		            ...
		            <tr class="thTdPadding">
		            	...
		            	<td>
			            	<div>
			            		<select name="workContent" id="workContentEdit" style="width:100%;height:25px" data-rules="{sele:''}">
			            		</select>
			            	</div>
		            	</td>
		            	<th><s>*</s>所属专业</th>
		            	<td>
			            	<div>
			            		<select name="belongCraft" id="belongCraftEdit" style="width:100%;height:25px" data-rules="{sele:''}">
			            		</select>
			            	</div>
		            	</td>
	          		</tr>
	          		<tr class="thTdPadding">
	          			<th><s>*</s>施工类别</th>
	           			<td>
			            	<div>
			            		<select name="executionType" id="executionTypeEdit" style="width:100%;height:25px" data-rules="{sele:''}">
			            		</select>
			            	</div>
		            	</td>
	           			<th><s>*</s>施工属性</th>
	           			<td>
			            	<div>
			            		<select name="executionAttr"  id="executionAttrEdit" style="width:100%;height:25px" data-rules="{sele:''}">
			            		</select>
			            	</div>
		            	</td>
		            </tr>
...
<script type="text/javascript">
	...
	function getParamEdit(){
		return {
            ...
            skyLight: $("#skyLightEdit").find("option:selected").val(),
		};
	}
</script>
</body>
