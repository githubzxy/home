...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="com.enovell.yunwei.safeSystem.domain.SafeSystem,com.enovell.yunwei.attach.domain.AttachFile"%>
<%             
	String contextPath = request.getContextPath(); 
	SafeSystem m = (SafeSystem)request.getAttribute("messageData");
...
<!--                     </li> -->
        ...
        <div class="container detailDiv">
            <div class="module_title">
                <span>&nbsp;<a href="<%=contextPath%>/index.jsp">首页</a>/<a href="javascript:history.back(-1)">返回</a>/安全规章</span>
                <span></span>
            </div>
