...
<table border=0 cellpadding=0 cellspacing=0 width=3346 class=xl6723036
 ...
 <tr height=21 style='height:15.75pt'>
  ...
  src="../views/report/wired/wiredMonthTwoFault/wiredMonthTwoFault.files/image006.png"></span><span
  style=''>
...
function exportBtn() {
	$("#updateForm").attr("action", "/kunmingrinms/wiredMonthTwoFaultAction/exportWorkShop.cn");
	$("#updateForm").submit();
}
</script>
</body>
