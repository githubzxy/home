...
<title>新增无线列调机车电台（货车列尾司机控制盒）故障统计及分析汇总表</title>
...
<table border=0 cellpadding=0 cellspacing=0 width=1080 class=xl9727048
 ...
 <tr class="xl9827048" height=33 style='height:24.95pt'>
  ...
  <td class="xl10127048 faultSum" width=76 style='border-top:none;border-left:none;width:57pt'></td>
  <td class="xl10127048 stationHost" width=45 style='border-top:none;border-left:none;width:34pt'></td>
  <td class="xl10127048 controlBox" width=45 style='border-top:none;border-left:none;width:34pt'></td>
  <td class="xl10127048 powerSupply" width=45 style='border-top:none;border-left:none;width:34pt'></td>
  <td class="xl10127048 microphone" width=45 style='border-top:none;border-left:none;width:34pt'></td>
  <td class="xl10127048 voiceDevice" width=45 style='border-top:none;border-left:none;width:34pt'></td>
  <td class="xl10127048 stationAntenna" width=45 style='border-top:none;border-left:none;width:34pt'></td>
  <td class="xl10127048 stationOther" width=45 style='border-top:none;border-left:none;width:34pt'></td>
  <td class="xl10127048 rearControlBox" width=45 style='border-top:none;border-left:none;width:34pt'></td>
  <td class="xl10127048 rearAntenna" width=45 style='border-top:none;border-left:none;width:34pt'></td>
  <td class="xl10127048 rearOther" width=45 style='border-top:none;border-left:none;width:34pt'></td>
  <td class="xl10127048 violationHumanR" width=45 style='border-top:none;border-left:none;width:34pt'></td>
  <td class="xl10127048 poorMaintenanceR" width=45 style='border-top:none;border-left:none;width:34pt'></td>
  <td class="xl10127048 powerSupplyR" width=45 style='border-top:none;border-left:none;width:34pt'></td>
  <td class="xl10127048 usersDamagedR" width=45 style='border-top:none;border-left:none;width:34pt'></td>
  <td class="xl10127048 materialAdverseR" width=45 style='border-top:none;border-left:none;width:34pt'></td>
  <td class="xl10127048 outsideImpedeR" width=45 style='border-top:none;border-left:none;width:34pt'></td>
  <td class="xl10127048 touchBad" width=45 style='border-top:none;border-left:none;width:34pt'></td>
  <td class="xl10127048" width=45>
<!--     <a class="sumRow" href="#" id="sum">计算总计</a> -->
 ...
 <tr style='height:200px'>
  ...
  <td colspan=10 class="xl10127048" width=547 style='width:412pt;height: 200px;'>
  	<textarea id="faultAnalysis" class="editStringCell" maxlength="250" style="border:none;width: 99.1%;height: 100%;resize: none;" placeholder="最多输入250个字符"></textarea>
  </td>
  ...
  <td colspan=9 class="xl10127048" width=360 style='width:272pt;'>
    <textarea id="adviceMeasure" class="editStringCell" maxlength="250" style="border:none;width: 99%;height: 100%;resize: none;" placeholder="最多输入250个字符"></textarea>
  </td>
 </tr>
 <tr height=33 style='height:24.95pt'>
  ...
  <td colspan=3 class="xl10827048 fillEditCell" id="phone"></td>
  <td class=xl9827048></td>
  <td class=xl9827048></td>
...
function getSumColData(){
	...
	$('.faultSum').html(faultSum);
	$('.stationHost').html(stationHost);
	$('.controlBox').html(controlBox);
	$('.powerSupply').html(powerSupply);
	$('.microphone').html(microphone);
	$('.voiceDevice').html(voiceDevice);
	$('.stationAntenna').html(stationAntenna);
	$('.stationOther').html(stationOther);
	$('.rearControlBox').html(rearControlBox);
	$('.rearAntenna').html(rearAntenna);
	$('.rearOther').html(rearOther);
	$('.violationHumanR').html(violationHumanR);
	$('.poorMaintenanceR').html(poorMaintenanceR);
	$('.powerSupplyR').html(powerSupplyR);
	$('.usersDamagedR').html(usersDamagedR);
	$('.materialAdverseR').html(materialAdverseR);
	$('.outsideImpedeR').html(outsideImpedeR);
	$('.touchBad').html(touchBad);
}
// 若为空,则转换为0
