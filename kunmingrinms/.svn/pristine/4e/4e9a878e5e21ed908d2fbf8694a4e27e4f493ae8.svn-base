...
<body style="overflow: hidden;">
    ...
    <form action="/kunmingrinms/toDoTaskRootAction/expToDoTask.cn" id="exportForm" method="post">
        <input type="hidden" id="exportXlsJson" name="exportXlsJson">
        <input type="hidden" value="待办任务" name="fileName">
    </form>
...
//      }));
        ...
        store = new Data.Store({
            url : contextPath+'toDoTaskRootAction/getTaskShowDtoOfToDo.cn',
            pageSize : 10,
            proxy : {
                method : 'post',
                dataType : 'json'
        ...
        function exportXls(records){
            ...
            for(var i = 0 ; i < records.length ; i++){
                ...
                json += '{'
                    ...
                    +'"taskType":'+'"'+taskManage_taskType.typeName(row.root.taskType)+'",'
