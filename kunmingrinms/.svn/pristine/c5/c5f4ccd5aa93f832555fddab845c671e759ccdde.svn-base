...
<table border=0 cellpadding=0 cellspacing=0 width=1186 class=xl6620428
 ...
 <tr class="editRow" height=33 style='height:24.95pt'>
  ...
  <c:forEach items="${requestScope.result[0]}" varStatus="i" var="item" begin="3" end="3">
	<td class="xl6820428 editCell intCell" style='border-top:none;border-left:none'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.result[0]}" varStatus="i" var="item" begin="4" end="18">
	<td class="xl6820428 editCell doubleCell" style='border-top:none;border-left:none'>${item}</td>
  </c:forEach>
 </tr>
 <tr class="editRow"  height=33 style='height:24.95pt'>
  ...
  <c:forEach items="${requestScope.result[1]}" varStatus="i" var="item" begin="3" end="3">
	<td class="xl6820428 editCell intCell" style='border-top:none;border-left:none'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.result[1]}" varStatus="i" var="item" begin="4" end="18">
	<td class="xl6820428 editCell doubleCell" style='border-top:none;border-left:none'>${item}</td>
  </c:forEach>
 </tr>
 <tr class="editRow"  height=33 style='height:24.95pt'>
  ...
  <c:forEach items="${requestScope.result[2]}" varStatus="i" var="item" begin="3" end="3">
	<td class="xl6820428 editCell intCell" style='border-top:none;border-left:none'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.result[2]}" varStatus="i" var="item" begin="4" end="18">
	<td class="xl6820428 editCell doubleCell" style='border-top:none;border-left:none'>${item}</td>
  </c:forEach>
 </tr>
 <tr class="editRow"  height=33 style='height:24.95pt'>
  ...
  <c:forEach items="${requestScope.result[3]}" varStatus="i" var="item" begin="3" end="3">
	<td class="xl6820428 editCell intCell" style='border-top:none;border-left:none'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.result[3]}" varStatus="i" var="item" begin="4" end="18">
	<td class="xl6820428 editCell doubleCell" style='border-top:none;border-left:none'>${item}</td>
  </c:forEach>
 </tr>
 <tr class="editRow"  height=33 style='height:24.95pt'>
  ...
  <c:forEach items="${requestScope.result[4]}" varStatus="i" var="item" begin="3" end="3">
	<td class="xl6820428 editCell intCell" style='border-top:none;border-left:none'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.result[4]}" varStatus="i" var="item" begin="4" end="18">
	<td class="xl6820428 editCell doubleCell" style='border-top:none;border-left:none'>${item}</td>
  </c:forEach>
 </tr>
 <tr class="editRow"  height=33 style='height:24.95pt'>
  ...
  <c:forEach items="${requestScope.result[5]}" varStatus="i" var="item" begin="3" end="3">
	<td class="xl6820428 editCell intCell" style='border-top:none;border-left:none'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.result[5]}" varStatus="i" var="item" begin="4" end="18">
	<td class="xl6820428 editCell doubleCell" style='border-top:none;border-left:none'>${item}</td>
  </c:forEach>
 </tr>
 <tr class="editRow"  height=33 style='height:24.95pt'>
  ...
  <c:forEach items="${requestScope.result[6]}" varStatus="i" var="item" begin="3" end="3">
	<td class="xl6820428 editCell intCell" style='border-top:none;border-left:none'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.result[6]}" varStatus="i" var="item" begin="4" end="18">
	<td class="xl6820428 editCell doubleCell" style='border-top:none;border-left:none'>${item}</td>
  </c:forEach>
 </tr>
 <tr class="editRow"  height=33 style='height:24.95pt'>
  ...
  <c:forEach items="${requestScope.result[7]}" varStatus="i" var="item" begin="3" end="3">
	<td class="xl6820428 editCell intCell" style='border-top:none;border-left:none'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.result[7]}" varStatus="i" var="item" begin="4" end="18">
	<td class="xl6820428 editCell doubleCell" style='border-top:none;border-left:none'>${item}</td>
  </c:forEach>
 </tr>
 <tr class="editRow"  height=33 style='height:24.95pt'>
  ...
  <c:forEach items="${requestScope.result[8]}" varStatus="i" var="item" begin="3" end="3">
	<td class="xl6820428 editCell intCell" style='border-top:none;border-left:none'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.result[8]}" varStatus="i" var="item" begin="4" end="18">
	<td class="xl6820428 editCell doubleCell" style='border-top:none;border-left:none'>${item}</td>
  </c:forEach>
 </tr>
 <tr height=33 style='height:24.95pt'>
  ...
  <td colspan=3 class="xl7020428" id="userId">${requestScope.result[0][22] }</td>
  <td class=xl6620428></td>
  <td class=xl6620428></td>
  <td class=xl6620428></td>
  <td colspan=2 class=xl8020428>联系电话：</td>
  <td colspan=2 class="xl7920428 fillEditCell" id="phone">${requestScope.result[0][23] }</td> <!-- ${requestScope.result[0][65] }  根据后台返回数据而定 -->
  <td class=xl6620428></td>
  <td class=xl6620428></td>
  <td class=xl6620428></td>
  <td class=xl6620428></td>
...
function getSaveData() {
	...
	var idArr=[];
	idArr[0]='${requestScope.result[0][19] }';
	idArr[1]='${requestScope.result[1][19] }';
	idArr[2]='${requestScope.result[2][19] }';
	idArr[3]='${requestScope.result[3][19] }';
	idArr[4]='${requestScope.result[4][19] }';
	idArr[5]='${requestScope.result[5][19] }';
	idArr[6]='${requestScope.result[6][19] }';
	idArr[7]='${requestScope.result[7][19] }';
	idArr[8]='${requestScope.result[8][19] }';
...
function exportBtn() {
	...
	if(!validateDoubleNumber($(".editRow .editCell"))){//验证浮点数单元格
		alert("请输入有效的非负数字！");
		return false;
	};
	var commSysUsingQuality = getSaveData();
	$.post(contextPath + 'wiredCommSysUsingQualityAction/add.cn',
			{
				...
				if(status){
					$("#updateForm").attr("action", "/kunmingrinms/wiredCommSysUsingQualityAction/exportWorkShop.cn");
					$("#updateForm").submit();
				}else{
					alert("保存失败!");
				}
