 ...
 */
@Entity
@Table(name = "DAILY_SPAREPART")
public class DailySparePart implements Serializable {
...
//	private Integer speciality;
	 ...
	 * 设备名称
	 */
	private DailyDeviceName sparePartName;
	/**
	 * 规格型号
	 */
...
//	}
	...
	public DailyDeviceName getSparePartName() {
		return sparePartName;
	}

	public void setSparePartName(DailyDeviceName sparePartName) {
...
//	}
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof DailySparePart)) {
            return false;
        }
		DailySparePart other = (DailySparePart) object;
	...
	public String toString() {
		return "DailySparePart [id=" + id + ", platesName=" + platesName + ", availableModle=" + availableModle
				+ ", singleNumber=" + singleNumber + ", amount=" + amount + ", speciality=" + speciality
				+ ", sparePartName=" + sparePartName + ", sparePartModel=" + sparePartModel + ", workShop=" + workShop
				+ ", workArea=" + workArea + ", createDate=" + createDate + ", comment=" + comment + ", factory="
				+ factory + ", depositLocation=" + depositLocation + ", deviceProperties=" + deviceProperties
				+ ", checkStatus=" + checkStatus + ", checkUser=" + checkUser + ", checkDate=" + checkDate + ", exist="
				+ exist + ", buyDate=" + buyDate + ", buyReason=" + buyReason + ", inDate=" + inDate
