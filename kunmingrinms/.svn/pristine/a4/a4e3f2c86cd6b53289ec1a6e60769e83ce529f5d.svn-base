...
<table border=0 cellpadding=0 cellspacing=0 width=1111 class=xl978860
 ...
 <tr height=22 style='height:16.5pt'>
  ...
  <td colspan=8 class=xl1118860 id="belongOrgName" style="white-space:normal;">${requestScope.list1[0][39]}</td>
...
<!-- -------------------------------------------------------------------------------- -->
 <tr class="xl988860 sheetOne" height=21 style='height:15.95pt' id="bjht">
  ...
  <c:forEach items="${requestScope.list1[0]}" varStatus="i" var="item" begin="0" end="0">
  	<td class="xl1028860 editCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[0]}" varStatus="i" var="item" begin="1" end="1">
  	<td class="xl1028860 sumCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[0]}" varStatus="i" var="item" begin="2" end="19">
  	<td class="xl1028860 editCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[0]}" varStatus="i" var="item" begin="20" end="20">
  	<td class="xl1028860 sumCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[0]}" varStatus="i" var="item" begin="21" end="23">
  	<td class="xl1028860 editCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[0]}" varStatus="i" var="item" begin="24" end="24">
  	<td class="xl1028860 sumCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[0]}" varStatus="i" var="item" begin="25" end="34">
  	<td class="xl1028860 editCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[0]}" varStatus="i" var="item" begin="35" end="35">
  	<td class="xl1028860 sumCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
 </tr>
 <tr class="xl988860 sheetOne" height=21 style='height:15.95pt'>
  ...
  <c:forEach items="${requestScope.list1[1]}" varStatus="i" var="item" begin="2" end="19">
  	<td class="xl1028860 editCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[1]}" varStatus="i" var="item" begin="20" end="20">
  	<td class="xl1028860 sumCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[1]}" varStatus="i" var="item" begin="21" end="23">
  	<td class="xl1028860 editCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[1]}" varStatus="i" var="item" begin="24" end="24">
  	<td class="xl1028860 sumCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[1]}" varStatus="i" var="item" begin="25" end="34">
  	<td class="xl1028860 editCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[1]}" varStatus="i" var="item" begin="35" end="35">
  	<td class="xl1028860 sumCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
 </tr>
 <tr class="xl988860 sheetOne" height=21 style='height:15.95pt'>
  ...
  <c:forEach items="${requestScope.list1[2]}" varStatus="i" var="item" begin="2" end="19">
  	<td class="xl1028860 editCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[2]}" varStatus="i" var="item" begin="20" end="20">
  	<td class="xl1028860 sumCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[2]}" varStatus="i" var="item" begin="21" end="23">
  	<td class="xl1028860 editCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[2]}" varStatus="i" var="item" begin="24" end="24">
  	<td class="xl1028860 sumCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[2]}" varStatus="i" var="item" begin="25" end="34">
  	<td class="xl1028860 editCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[2]}" varStatus="i" var="item" begin="35" end="35">
  	<td class="xl1028860 sumCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
 </tr>
 <tr class="xl988860 sheetOne" height=21 style='height:15.95pt'>
  ...
  <c:forEach items="${requestScope.list1[3]}" varStatus="i" var="item" begin="2" end="19">
  	<td class="xl1028860 editCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[3]}" varStatus="i" var="item" begin="20" end="20">
  	<td class="xl1028860 sumCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[3]}" varStatus="i" var="item" begin="21" end="23">
  	<td class="xl1028860 editCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[3]}" varStatus="i" var="item" begin="24" end="24">
  	<td class="xl1028860 sumCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[3]}" varStatus="i" var="item" begin="25" end="34">
  	<td class="xl1028860 editCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[3]}" varStatus="i" var="item" begin="35" end="35">
  	<td class="xl1028860 sumCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
 </tr>
 <tr class="xl988860 sheetOne" height=21 style='height:15.95pt'>
  ...
  <c:forEach items="${requestScope.list1[4]}" varStatus="i" var="item" begin="2" end="19">
  	<td class="xl1028860 editCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[4]}" varStatus="i" var="item" begin="20" end="20">
  	<td class="xl1028860 sumCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[4]}" varStatus="i" var="item" begin="21" end="23">
  	<td class="xl1028860 editCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[4]}" varStatus="i" var="item" begin="24" end="24">
  	<td class="xl1028860 sumCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[4]}" varStatus="i" var="item" begin="25" end="34">
  	<td class="xl1028860 editCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[4]}" varStatus="i" var="item" begin="35" end="35">
  	<td class="xl1028860 sumCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
 </tr>
 <tr class="xl988860 sheetOne" height=21 style='height:15.95pt'>
  ...
  <c:forEach items="${requestScope.list1[5]}" varStatus="i" var="item" begin="2" end="19">
  	<td class="xl1028860 editCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[5]}" varStatus="i" var="item" begin="20" end="20">
  	<td class="xl1028860 sumCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[5]}" varStatus="i" var="item" begin="21" end="23">
  	<td class="xl1028860 editCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[5]}" varStatus="i" var="item" begin="24" end="24">
  	<td class="xl1028860 sumCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[5]}" varStatus="i" var="item" begin="25" end="34">
  	<td class="xl1028860 editCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[5]}" varStatus="i" var="item" begin="35" end="35">
  	<td class="xl1028860 sumCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
 </tr>
 <tr class="xl988860 sheetOne" height=21 style='height:15.95pt'>
  ...
  <c:forEach items="${requestScope.list1[6]}" varStatus="i" var="item" begin="2" end="19">
  	<td class="xl1028860 editCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[6]}" varStatus="i" var="item" begin="20" end="20">
  	<td class="xl1028860 sumCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[6]}" varStatus="i" var="item" begin="21" end="23">
  	<td class="xl1028860 editCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[6]}" varStatus="i" var="item" begin="24" end="24">
  	<td class="xl1028860 sumCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[6]}" varStatus="i" var="item" begin="25" end="34">
  	<td class="xl1028860 editCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[6]}" varStatus="i" var="item" begin="35" end="35">
  	<td class="xl1028860 sumCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
 </tr>
 <tr class="xl988860 sheetOne" height=21 style='height:15.95pt'>
  ...
  <c:forEach items="${requestScope.list1[7]}" varStatus="i" var="item" begin="2" end="19">
  	<td class="xl1028860 editCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[7]}" varStatus="i" var="item" begin="20" end="20">
  	<td class="xl1028860 sumCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[7]}" varStatus="i" var="item" begin="21" end="23">
  	<td class="xl1028860 editCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[7]}" varStatus="i" var="item" begin="24" end="24">
  	<td class="xl1028860 sumCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[7]}" varStatus="i" var="item" begin="25" end="34">
  	<td class="xl1028860 editCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[7]}" varStatus="i" var="item" begin="35" end="35">
  	<td class="xl1028860 sumCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
 </tr>
 <tr class="xl988860 sheetOne" height=21 style='height:15.95pt'>
  ...
  <c:forEach items="${requestScope.list1[8]}" varStatus="i" var="item" begin="2" end="19">
  	<td class="xl1028860 editCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[8]}" varStatus="i" var="item" begin="20" end="20">
  	<td class="xl1028860 sumCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[8]}" varStatus="i" var="item" begin="21" end="23">
  	<td class="xl1028860 editCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[8]}" varStatus="i" var="item" begin="24" end="24">
  	<td class="xl1028860 sumCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[8]}" varStatus="i" var="item" begin="25" end="34">
  	<td class="xl1028860 editCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[8]}" varStatus="i" var="item" begin="35" end="35">
  	<td class="xl1028860 sumCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
 </tr>
 <tr class="xl988860 sheetOne" height=21 style='height:15.95pt'>
  ...
  <c:forEach items="${requestScope.list1[9]}" varStatus="i" var="item" begin="2" end="19">
  	<td class="xl1028860 editCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[9]}" varStatus="i" var="item" begin="20" end="20">
  	<td class="xl1028860 sumCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[9]}" varStatus="i" var="item" begin="21" end="23">
  	<td class="xl1028860 editCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[9]}" varStatus="i" var="item" begin="24" end="24">
  	<td class="xl1028860 sumCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[9]}" varStatus="i" var="item" begin="25" end="34">
  	<td class="xl1028860 editCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[9]}" varStatus="i" var="item" begin="35" end="35">
  	<td class="xl1028860 sumCell cell data" style='border-top:none;border-left:none' >${item}</td>
  </c:forEach>
 </tr>
 <tr class="xl988860 sheetOne" height=21 style='height:15.95pt'>
  ...
  <c:forEach items="${requestScope.list1[10]}" varStatus="i" var="item" begin="0" end="35">
  	<td class="xl1028860 sumCell data" style='border-top:none;border-left:none' id="line${i.count-1}">${item}</td>
  </c:forEach>
 </tr>
 ...
 <tr class="xl988860 sheetTwo" height=21 style='height:15.95pt'>
  ...
  <c:forEach items="${requestScope.list2[0]}" varStatus="i" var="item" begin="0" end="2">
  	<td colspan=3 class="xl1028860 sumCell cell data" style='border-left:none'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list2[0]}" varStatus="i" var="item" begin="3" end="3">
  	<td colspan=3 class="xl1148860 sumCell cell data" style='border-left:none'>${item}</td>
  </c:forEach>
  <td colspan=24 rowspan=11 class="xl1138860" id="remark">
  	 <textarea id="faultAnalysis" class="remarkCell" style="width:99%;height:100%;resize:none;margin-right:-1px;margin-bottom:-4px;" maxlength="250" placeholder="请输入，字数限250个"/>${requestScope.list2[0][4]}</textarea>
  </td>
 </tr>
 <tr class="xl988860 sheetTwo" height=21 style='height:15.95pt'>
  <td colspan=3 height=21 class=xl1018860 style='height:15.95pt'>2</td>
  <td class=xl1018860 style='border-top:none;border-left:none' id="s22">天津712厂</td>
  <c:forEach items="${requestScope.list2[1]}" varStatus="i" var="item" begin="0" end="2">
  	<td colspan=3 class="xl1028860 sumCell cell data" style='border-left:none'>${item}</td>
  </c:forEach>
 ...
 <tr class="xl988860 sheetTwo" height=21 style='height:15.95pt'>
  ...
  <c:forEach items="${requestScope.list2[2]}" varStatus="i" var="item" begin="0" end="2">
  	<td colspan=3 class="xl1028860 sumCell cell data" style='border-left:none'>${item}</td>
  </c:forEach>
 ...
 <tr class="xl988860 sheetTwo" height=21 style='height:15.95pt'>
  ...
  <c:forEach items="${requestScope.list2[3]}" varStatus="i" var="item" begin="0" end="2">
  	<td colspan=3 class="xl1028860 sumCell cell data" style='border-left:none'>${item}</td>
  </c:forEach>
 ...
 <tr class="xl988860 sheetTwo" height=21 style='height:15.95pt'>
  ...
  <c:forEach items="${requestScope.list2[4]}" varStatus="i" var="item" begin="0" end="2">
  	<td colspan=3 class="xl1028860 sumCell cell data" style='border-left:none'>${item}</td>
  </c:forEach>
 ...
 <tr class="xl988860 sheetTwo" height=21 style='height:15.95pt'>
  ...
  <c:forEach items="${requestScope.list2[5]}" varStatus="i" var="item" begin="0" end="2">
  	<td colspan=3 class="xl1028860 sumCell cell data" style='border-left:none'>${item}</td>
  </c:forEach>
 ...
 <tr class="xl988860 sheetTwo" height=21 style='height:15.95pt'>
  ...
  <c:forEach items="${requestScope.list2[6]}" varStatus="i" var="item" begin="0" end="2">
  	<td colspan=3 class="xl1028860 sumCell cell data" style='border-left:none'>${item}</td>
  </c:forEach>
 ...
 <tr class="xl988860 sheetTwo" height=21 style='height:15.95pt'>
  ...
  <c:forEach items="${requestScope.list2[7]}" varStatus="i" var="item" begin="0" end="2">
  	<td colspan=3 class="xl1028860 sumCell cell data" style='border-left:none'>${item}</td>
  </c:forEach>
 ...
 <tr class="xl988860 sheetTwo" height=21 style='height:15.95pt'>
  ...
  <c:forEach items="${requestScope.list2[8]}" varStatus="i" var="item" begin="0" end="2">
  	<td colspan=3 class="xl1028860 sumCell cell data" style='border-left:none'>${item}</td>
  </c:forEach>
 ...
 <tr class="xl988860 sheetTwo" height=21 style='height:15.95pt'>
  ...
  <c:forEach items="${requestScope.list2[9]}" varStatus="i" var="item" begin="0" end="2">
  	<td colspan=3 class="xl1028860 sumCell cell data" style='border-left:none'>${item}</td>
  </c:forEach>
 ...
 <tr class="xl988860 sheetTwo" height=21 style='height:15.95pt'>
  ...
  <c:forEach items="${requestScope.list2[10]}" varStatus="i" var="item" begin="0" end="3">
  	<td colspan=3 class="xl1148860 sumCell data" style='border-left:none' id="lineTwo${i.count-1}">${item}</td>
  </c:forEach>
 </tr>
 <!-- -----------------------------------正文结束--------------------------------------------- --> 
 <!-- -----------------------------------底部开始--------------------------------------------- --> 
		...
		$.post(contextPath + 'wirelessDeviceSheetTwoAction/add.cn',
				{
					...
					if(status){
						$("#updateForm").attr("action", "/kunmingrinms/wirelessDeviceSheetTwoAction/exportShow.cn");
						$("#updateForm").submit();
					}else{
						alert("保存失败!");
					}
