...
<table border=0 cellpadding=0 cellspacing=0 width=1111 class=xl978860
 ...
 <tr height=22 style='height:16.5pt'>
  ...
  <td colspan=36 class=xl1118860 id="belongOrgName" style="white-space: normal;">${requestScope.belongDepartName}</td>
 </tr>
 <tr class=xl988860 height=33 style='height:24.95pt'>
  ...
  src="/kunmingrinms/views/report/wireless/wirelessDeviceSheetTwo/wirelessDeviceSheetTwo.files/wirelessWorkShopCir_8860_image001.png"></span><span
  style=''>
...
<!-- -------------------------------------------------------------------------------- -->
 <tr class="xl988860 sheetOne" height=21 style='height:15.95pt' id="bjht">
  ...
  <c:forEach items="${requestScope.resultA[0]}" varStatus="i" var="item" begin="0" end="35">
 ...
 <tr class="xl988860 sheetOne" height=21 style='height:15.95pt'>
  ...
  <c:forEach items="${requestScope.resultA[1]}" varStatus="i" var="item" begin="0" end="35">
  	<td class="xl1028860 Cell" style='border-top:none;border-left:none'>${item}</td>
  </c:forEach>
 ...
 <tr class="xl988860 sheetOne" height=21 style='height:15.95pt'>
  ...
  <c:forEach items="${requestScope.resultA[2]}" varStatus="i" var="item" begin="0" end="35">
  	<td class="xl1028860 Cell" style='border-top:none;border-left:none'>${item}</td>
  </c:forEach>
 ...
 <tr class="xl988860 sheetOne" height=21 style='height:15.95pt'>
  ...
  <c:forEach items="${requestScope.resultA[3]}" varStatus="i" var="item" begin="0" end="35">
  	<td class="xl1028860 Cell " style='border-top:none;border-left:none'>${item}</td>
  </c:forEach>
 ...
 <tr class="xl988860 sheetOne" height=21 style='height:15.95pt'>
  ...
  <c:forEach items="${requestScope.resultA[4]}" varStatus="i" var="item" begin="0" end="35">
  	<td class="xl1028860 Cell " style='border-top:none;border-left:none'>${item}</td>
  </c:forEach>
 ...
 <tr class="xl988860 sheetOne" height=21 style='height:15.95pt'>
  ...
  <c:forEach items="${requestScope.resultA[5]}" varStatus="i" var="item" begin="0" end="35">
  	<td class="xl1028860 Cell " style='border-top:none;border-left:none'>${item}</td>
  </c:forEach>
 ...
 <tr class="xl988860 sheetOne" height=21 style='height:15.95pt'>
  ...
  <c:forEach items="${requestScope.resultA[6]}" varStatus="i" var="item" begin="0" end="35">
  	<td class="xl1028860 Cell " style='border-top:none;border-left:none'>${item}</td>
  </c:forEach>
 ...
 <tr class="xl988860 sheetOne" height=21 style='height:15.95pt'>
  ...
  <c:forEach items="${requestScope.resultA[7]}" varStatus="i" var="item" begin="0" end="35">
  	<td class="xl1028860 Cell " style='border-top:none;border-left:none'>${item}</td>
  </c:forEach>
 ...
 <tr class="xl988860 sheetOne" height=21 style='height:15.95pt'>
  ...
  <c:forEach items="${requestScope.resultA[8]}" varStatus="i" var="item" begin="0" end="35">
  	<td class="xl1028860 Cell " style='border-top:none;border-left:none'>${item}</td>
  </c:forEach>
 ...
 <tr class="xl988860 sheetOne" height=21 style='height:15.95pt'>
  ...
  <c:forEach items="${requestScope.resultA[9]}" varStatus="i" var="item" begin="0" end="35">
  	<td class="xl1028860 Cell " style='border-top:none;border-left:none'>${item}</td>
  </c:forEach>
 ...
 <tr class="xl988860 sheetOne" height=21 style='height:15.95pt'>
  ...
  <c:forEach items="${requestScope.resultA[10]}" varStatus="i" var="item" begin="0" end="35">
  	<td class="xl1028860 Cell " style='border-top:none;border-left:none'>${item}</td>
  </c:forEach>
 ...
 <tr class=xl988860 height=21 style='height:15.95pt'>
  <td colspan=3 rowspan=3 height=42 class=xl1208860 style='height:31.9pt;border-right:1.0pt solid black;border-bottom:1.0pt solid black;'>
  	<img width=58 height=70 src="/kunmingrinms/views/report/wireless/wirelessDeviceSheetTwo/wirelessDeviceSheetTwo.files/wirelessWorkShopCir_8860_image002.png">
  </td>
 ...
 <tr class="xl988860 sheetTwo" height=21 style='height:15.95pt'>
  ...
  <td colspan=3 class="xl1028860 Cell" style='border-left:none'>${requestScope.resultB[0][0]}</td>
  <td colspan=3 class="xl1028860 Cell" style='border-left:none'>${requestScope.resultB[0][1]}</td>
  <td colspan=3 class="xl1028860 Cell" style='border-left:none'>${requestScope.resultB[0][2]}</td>
  <td colspan=3 class="xl1148860 Cell" style='border-left:none'>${requestScope.resultB[0][3]}</td>
  <td colspan=24 rowspan=11 class="xl1018706" id="remark" style='border-right:1.0pt solid black; border-bottom:1.0pt solid black'>
<!--   	<div style='width:100%;height:240px;border-right:1.0pt solid black;overflow-y:auto'> -->
<%--   	<c:forEach items="${requestScope.allRemark}" varStatus="i" var="item" begin="0" > --%>
<%--   	<div style="width:620px;height:auto;border-right:1.0pt solid black;word-wrap:break-word;">${item}</div> --%>
<%--   	</c:forEach> --%>
<!--   	</div> -->
	<textarea style="border:none;width: 98.6%;height: 100%;resize: none;" readonly="readonly"><c:if test="${not empty allRemark}"><c:forEach items="allRemark">${allRemark }</c:forEach></c:if></textarea>
  </td>
 </tr>
 <tr class="xl988860 sheetTwo" height=21 style='height:15.95pt'>
  <td colspan=3 height=21 class=xl1018860 style='height:15.95pt'>2</td>
  <td class=xl1018860 style='border-top:none;border-left:none' id="s22">天津712厂</td>
  <td colspan=3 class="xl1028860 Cell" style='border-left:none'>${requestScope.resultB[1][0]}</td>
  <td colspan=3 class="xl1028860 Cell" style='border-left:none'>${requestScope.resultB[1][1]}</td>
  <td colspan=3 class="xl1028860 Cell" style='border-left:none'>${requestScope.resultB[1][2]}</td>
  <td colspan=3 class="xl1148860 Cell" style='border-left:none'>${requestScope.resultB[1][3]}</td>
 </tr>
 <tr class="xl988860 sheetTwo" height=21 style='height:15.95pt'>
  <td colspan=3 height=21 class=xl1018860 style='height:15.95pt'>3</td>
  <td class=xl1018860 style='border-top:none;border-left:none' id="s23">上海通信工厂</td>
  <td colspan=3 class="xl1028860 Cell" style='border-left:none'>${requestScope.resultB[2][0]}</td>
  <td colspan=3 class="xl1028860 Cell" style='border-left:none'>${requestScope.resultB[2][1]}</td>
  <td colspan=3 class="xl1028860 Cell" style='border-left:none'>${requestScope.resultB[2][2]}</td>
  <td colspan=3 class="xl1148860 Cell" style='border-left:none'>${requestScope.resultB[2][3]}</td>
 </tr>
 <tr class="xl988860 sheetTwo" height=21 style='height:15.95pt'>
  <td colspan=3 height=21 class=xl1018860 style='height:15.95pt'>4</td>
  <td class=xl1018860 style='border-top:none;border-left:none' id="s24">北京希电公司</td>
  <td colspan=3 class="xl1028860 Cell" style='border-left:none'>${requestScope.resultB[3][0]}</td>
  <td colspan=3 class="xl1028860 Cell" style='border-left:none'>${requestScope.resultB[3][1]}</td>
  <td colspan=3 class="xl1028860 Cell" style='border-left:none'>${requestScope.resultB[3][2]}</td>
  <td colspan=3 class="xl1148860 Cell" style='border-left:none'>${requestScope.resultB[3][3]}</td>
 </tr>
 <tr class="xl988860 sheetTwo" height=21 style='height:15.95pt'>
  <td colspan=3 height=21 class=xl1018860 style='height:15.95pt'>5</td>
  <td class=xl1018860 style='border-top:none;border-left:none' id="s25">深圳长龙公司</td>
  <td colspan=3 class="xl1028860 Cell" style='border-left:none'>${requestScope.resultB[4][0]}</td>
  <td colspan=3 class="xl1028860 Cell" style='border-left:none'>${requestScope.resultB[4][1]}</td>
  <td colspan=3 class="xl1028860 Cell" style='border-left:none'>${requestScope.resultB[4][2]}</td>
  <td colspan=3 class="xl1148860 Cell" style='border-left:none'>${requestScope.resultB[4][3]}</td>
 </tr>
 <tr class="xl988860 sheetTwo" height=21 style='height:15.95pt'>
  <td colspan=3 height=21 class=xl1018860 style='height:15.95pt'>6</td>
  <td class=xl1018860 style='border-top:none;border-left:none' id="s26">杭州创联公司</td>
  <td colspan=3 class="xl1028860 Cell" style='border-left:none'>${requestScope.resultB[5][0]}</td>
  <td colspan=3 class="xl1028860 Cell" style='border-left:none'>${requestScope.resultB[5][1]}</td>
  <td colspan=3 class="xl1028860 Cell" style='border-left:none'>${requestScope.resultB[5][2]}</td>
  <td colspan=3 class="xl1148860 Cell" style='border-left:none'>${requestScope.resultB[5][3]}</td>
 </tr>
 <tr class="xl988860 sheetTwo" height=21 style='height:15.95pt'>
  <td colspan=3 height=21 class=xl1018860 style='height:15.95pt'>7</td>
  <td class=xl1018860 style='border-top:none;border-left:none' id="s27">世纪东方</td>
  <td colspan=3 class="xl1028860 Cell" style='border-left:none'>${requestScope.resultB[6][0]}</td>
  <td colspan=3 class="xl1028860 Cell" style='border-left:none'>${requestScope.resultB[6][1]}</td>
  <td colspan=3 class="xl1028860 Cell" style='border-left:none'>${requestScope.resultB[6][2]}</td>
  <td colspan=3 class="xl1148860 Cell" style='border-left:none'>${requestScope.resultB[6][3]}</td>
 </tr>
 <tr class="xl988860 sheetTwo" height=21 style='height:15.95pt'>
  <td colspan=3 height=21 class=xl1018860 style='height:15.95pt'>8</td>
  <td class=xl1018860 style='border-top:none;border-left:none' id="s28">上海复旦</td>
  <td colspan=3 class="xl1028860 Cell" style='border-left:none'>${requestScope.resultB[7][0]}</td>
  <td colspan=3 class="xl1028860 Cell" style='border-left:none'>${requestScope.resultB[7][1]}</td>
  <td colspan=3 class="xl1028860 Cell" style='border-left:none'>${requestScope.resultB[7][2]}</td>
  <td colspan=3 class="xl1148860 Cell" style='border-left:none'>${requestScope.resultB[7][3]}</td>
 </tr>
 <tr class="xl988860 sheetTwo" height=21 style='height:15.95pt'>
  <td colspan=3 height=21 class=xl1018860 style='height:15.95pt'>9</td>
  <td class=xl1018860 style='border-top:none;border-left:none' id="s29">河南辉煌</td>
  <td colspan=3 class="xl1028860 Cell" style='border-left:none'>${requestScope.resultB[8][0]}</td>
  <td colspan=3 class="xl1028860 Cell" style='border-left:none'>${requestScope.resultB[8][1]}</td>
  <td colspan=3 class="xl1028860 Cell" style='border-left:none'>${requestScope.resultB[8][2]}</td>
  <td colspan=3 class="xl1148860 Cell" style='border-left:none'>${requestScope.resultB[8][3]}</td>
 </tr>
 <tr class="xl988860 sheetTwo" height=21 style='height:15.95pt'>
  <td colspan=3 height=21 class=xl1018860 style='height:15.95pt'>10</td>
  <td class=xl1018860 style='border-top:none;border-left:none' id="s210">深圳思科泰</td>
  <td colspan=3 class="xl1028860 Cell" style='border-left:none'>${requestScope.resultB[9][0]}</td>
  <td colspan=3 class="xl1028860 Cell" style='border-left:none'>${requestScope.resultB[9][1]}</td>
  <td colspan=3 class="xl1028860 Cell" style='border-left:none'>${requestScope.resultB[9][2]}</td>
  <td colspan=3 class="xl1148860 Cell" style='border-left:none'>${requestScope.resultB[9][3]}</td>
 </tr>
 <tr class="xl988860 sheetTwo" height=21 style='height:15.95pt'>
  ...
  <td colspan=3 class="xl1148860 Cell" style='border-left:none'>${requestScope.resultB[10][0]}</td>
  <td colspan=3 class="xl1148860 Cell" style='border-left:none'>${requestScope.resultB[10][1]}</td>
  <td colspan=3 class="xl1148860 Cell" style='border-left:none'>${requestScope.resultB[10][2]}</td>
  <td colspan=3 class="xl1148860 Cell" style='border-left:none'>${requestScope.resultB[10][3]}</td>
 </tr>
 <!-- -----------------------------------正文结束--------------------------------------------- --> 
 <!-- -----------------------------------底部开始--------------------------------------------- --> 
 <!-- -----------------------------------底部结束--------------------------------------------- --> 
...
// 		$(".Cell").addClass("hiddenContext");
	...
	BUI.use(['bui/data', 'bui/select'], function(Data, Select) {
		var store = new Data.Store({
			autoLoad : true,
			proxy : {
				url : contextPath + "wirelessDeviceSheetTwoAction/getReportWorkshop.cn",
				method : 'post'
			},
			params : {
				year : $("#year").val(),
		...
		$("#searchBtn").click(function() {
			$("#showForm").attr("action", "/kunmingrinms/wirelessDeviceSheetTwoAction/getSegmentByDto.cn");
			$("#showForm").submit();
		});
		...
		$("#exportBtn").click(function() {
			if($("#belongDepart").val()==""){
				...
				$("#showForm").attr("action", "/kunmingrinms/wirelessDeviceSheetTwoAction/exportSegment.cn");
				$("#showForm").submit();
			}
		});
