...
<head>
<meta charset="utf-8">
<title>通信段通信设备（线路）质量提高计划表（明细）</title>
  ...
  <body style="padding: 10px;">
	  	 	...
	  	 	<table id="table1" class="autumn_table autumn_table_background"  >
	  	 		<thead>
		  	 		<tr>
		  	 			...
		  	 			<td colspan="6" class="left"><span id="table1_span_org" >昆明通信段</span></td>
		  	 			<td colspan="1">年度：</td>
	  	 		...
	  	 		<tr id = "base">
	  	 			...
	  	 			<td colspan="1">填报人：</td>
	  	 			<td colspan="4" class="left"><span id="fill_user" >昆明通信段</span></td>
	...
	<script type="text/javascript" src="<%=contextPath%>/resource/js/autumn/report_8_tongXinDuan.js"></script>
  </body>
</html>
