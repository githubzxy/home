...
<title>修改高铁、城际铁路CIR故障统计及分析表</title>
...
<table border=0 cellpadding=0 cellspacing=0 width=1066 style='border-collapse:
 ...
 <tr class="sheetOne" height=21 style='height:15.95pt'>
  ...
  <c:forEach items="${requestScope.list1[0]}" var="item" begin="0" end="0">
  	<td class="xl6516718 editCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[0]}" var="item" begin="1" end="1">
  	<td class="xl6516718 sumCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[0]}" var="item" begin="2" end="17">
  	<td class="xl6516718 editCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[0]}" var="item" begin="18" end="18">
  	<td class="xl6516718 sumCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[0]}" var="item" begin="19" end="21">
  	<td class="xl6516718 editCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[0]}" var="item" begin="22" end="22">
  	<td class="xl6516718 sumCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[0]}" var="item" begin="23" end="32">
  	<td class="xl6516718 editCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[0]}" var="item" begin="33" end="33">
  	<td class="xl6516718 sumCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:if test="${empty list1}">
  	<c:forEach var="item" begin="0" end="33">
  		<td class="xl6516718 editCell" width=27 style='border-top:none;border-left:none;width:20pt'></td>
  	</c:forEach>
  </c:if>
 </tr>
 <tr class="sheetOne" height=21 style='height:15.95pt'>
  ...
  <c:forEach items="${requestScope.list1[1]}" var="item" begin="0" end="0">
  	<td class="xl6516718 editCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[1]}" var="item" begin="1" end="1">
  	<td class="xl6516718 sumCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[1]}" var="item" begin="2" end="17">
  	<td class="xl6516718 editCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[1]}" var="item" begin="18" end="18">
  	<td class="xl6516718 sumCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[1]}" var="item" begin="19" end="21">
  	<td class="xl6516718 editCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[1]}" var="item" begin="22" end="22">
  	<td class="xl6516718 sumCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[1]}" var="item" begin="23" end="32">
  	<td class="xl6516718 editCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[1]}" var="item" begin="33" end="33">
  	<td class="xl6516718 sumCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:if test="${empty list1}">
  	<c:forEach var="item" begin="0" end="33">
 ...
 <tr class="sheetOne" height=21 style='height:15.95pt'>
  ...
  <c:forEach items="${requestScope.list1[2]}" var="item" begin="0" end="0">
  	<td class="xl6516718 editCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[2]}" var="item" begin="1" end="1">
  	<td class="xl6516718 sumCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[2]}" var="item" begin="2" end="17">
  	<td class="xl6516718 editCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[2]}" var="item" begin="18" end="18">
  	<td class="xl6516718 sumCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[2]}" var="item" begin="19" end="21">
  	<td class="xl6516718 editCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[2]}" var="item" begin="22" end="22">
  	<td class="xl6516718 sumCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[2]}" var="item" begin="23" end="32">
  	<td class="xl6516718 editCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[2]}" var="item" begin="33" end="33">
  	<td class="xl6516718 sumCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:if test="${empty list1}">
  	<c:forEach var="item" begin="0" end="33">
 ...
 <tr class="sheetOne" height=21 style='height:15.95pt'>
  ...
  <c:forEach items="${requestScope.list1[3]}" var="item" begin="0" end="0">
  	<td class="xl6516718 editCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[3]}" var="item" begin="1" end="1">
  	<td class="xl6516718 sumCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[3]}" var="item" begin="2" end="17">
  	<td class="xl6516718 editCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[3]}" var="item" begin="18" end="18">
  	<td class="xl6516718 sumCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[3]}" var="item" begin="19" end="21">
  	<td class="xl6516718 editCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[3]}" var="item" begin="22" end="22">
  	<td class="xl6516718 sumCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[3]}" var="item" begin="23" end="32">
  	<td class="xl6516718 editCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[3]}" var="item" begin="33" end="33">
  	<td class="xl6516718 sumCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:if test="${empty list1}">
  	<c:forEach var="item" begin="0" end="33">
 ...
 <tr class="sheetOne" height=21 style='height:15.95pt'>
  ...
  <c:forEach items="${requestScope.list1[4]}" var="item" begin="0" end="0">
  	<td class="xl6516718 editCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[4]}" var="item" begin="1" end="1">
  	<td class="xl6516718 sumCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[4]}" var="item" begin="2" end="17">
  	<td class="xl6516718 editCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[4]}" var="item" begin="18" end="18">
  	<td class="xl6516718 sumCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[4]}" var="item" begin="19" end="21">
  	<td class="xl6516718 editCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[4]}" var="item" begin="22" end="22">
  	<td class="xl6516718 sumCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[4]}" var="item" begin="23" end="32">
  	<td class="xl6516718 editCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[4]}" var="item" begin="33" end="33">
  	<td class="xl6516718 sumCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:if test="${empty list1}">
  	<c:forEach var="item" begin="0" end="33">
 ...
 <tr class="sheetOne" height=21 style='height:15.95pt'>
  ...
  <c:forEach items="${requestScope.list1[5]}" var="item" begin="0" end="0">
  	<td class="xl6516718 editCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[5]}" var="item" begin="1" end="1">
  	<td class="xl6516718 sumCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[5]}" var="item" begin="2" end="17">
  	<td class="xl6516718 editCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[5]}" var="item" begin="18" end="18">
  	<td class="xl6516718 sumCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[5]}" var="item" begin="19" end="21">
  	<td class="xl6516718 editCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[5]}" var="item" begin="22" end="22">
  	<td class="xl6516718 sumCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[5]}" var="item" begin="23" end="32">
  	<td class="xl6516718 editCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[5]}" var="item" begin="33" end="33">
  	<td class="xl6516718 sumCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:if test="${empty list1}">
  	<c:forEach var="item" begin="0" end="33">
 ...
 <tr class="sheetOne" height=21 style='height:15.95pt'>
  ...
  <c:forEach items="${requestScope.list1[6]}" var="item" begin="0" end="0">
  	<td class="xl6516718 editCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[6]}" var="item" begin="1" end="1">
  	<td class="xl6516718 sumCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[6]}" var="item" begin="2" end="17">
  	<td class="xl6516718 editCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[6]}" var="item" begin="18" end="18">
  	<td class="xl6516718 sumCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[6]}" var="item" begin="19" end="21">
  	<td class="xl6516718 editCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[6]}" var="item" begin="22" end="22">
  	<td class="xl6516718 sumCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[6]}" var="item" begin="23" end="32">
  	<td class="xl6516718 editCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[6]}" var="item" begin="33" end="33">
  	<td class="xl6516718 sumCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:if test="${empty list1}">
  	<c:forEach var="item" begin="0" end="33">
 ...
 <tr class="sheetOne" height=21 style='height:15.95pt'>
  ...
  <c:forEach items="${requestScope.list1[7]}" var="item" begin="0" end="0">
  	<td class="xl6516718 editCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[7]}" var="item" begin="1" end="1">
  	<td class="xl6516718 sumCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[7]}" var="item" begin="2" end="17">
  	<td class="xl6516718 editCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[7]}" var="item" begin="18" end="18">
  	<td class="xl6516718 sumCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[7]}" var="item" begin="19" end="21">
  	<td class="xl6516718 editCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[7]}" var="item" begin="22" end="22">
  	<td class="xl6516718 sumCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[7]}" var="item" begin="23" end="32">
  	<td class="xl6516718 editCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[7]}" var="item" begin="33" end="33">
  	<td class="xl6516718 sumCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:if test="${empty list1}">
  	<c:forEach var="item" begin="0" end="33">
 ...
 <tr class="sheetOne" height=21 style='height:15.95pt'>
  ...
  <c:forEach items="${requestScope.list1[8]}" var="item" begin="0" end="0">
  	<td class="xl6516718 editCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[8]}" var="item" begin="1" end="1">
  	<td class="xl6516718 sumCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[8]}" var="item" begin="2" end="17">
  	<td class="xl6516718 editCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[8]}" var="item" begin="18" end="18">
  	<td class="xl6516718 sumCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[8]}" var="item" begin="19" end="21">
  	<td class="xl6516718 editCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[8]}" var="item" begin="22" end="22">
  	<td class="xl6516718 sumCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[8]}" var="item" begin="23" end="32">
  	<td class="xl6516718 editCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[8]}" var="item" begin="33" end="33">
  	<td class="xl6516718 sumCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:if test="${empty list1}">
  	<c:forEach var="item" begin="0" end="33">
 ...
 <tr class="sheetOne" height=21 style='height:15.95pt'>
  ...
  <c:forEach items="${requestScope.list1[9]}" var="item" begin="0" end="0">
  	<td class="xl6516718 editCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[9]}" var="item" begin="1" end="1">
  	<td class="xl6516718 sumCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[9]}" var="item" begin="2" end="17">
  	<td class="xl6516718 editCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[9]}" var="item" begin="18" end="18">
  	<td class="xl6516718 sumCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[9]}" var="item" begin="19" end="21">
  	<td class="xl6516718 editCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[9]}" var="item" begin="22" end="22">
  	<td class="xl6516718 sumCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[9]}" var="item" begin="23" end="32">
  	<td class="xl6516718 editCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list1[9]}" var="item" begin="33" end="33">
  	<td class="xl6516718 sumCell cell data" width=27 style='border-top:none;border-left:none;width:20pt'>${item}</td>
  </c:forEach>
  <c:if test="${empty list1}">
  	<c:forEach var="item" begin="0" end="33">
 ...
 <tr class="sheetOne" height=21 style='height:15.95pt'>
  ...
  <c:forEach items="${requestScope.list1[10]}" varStatus="i" var="item" begin="0" end="33">
  	<td class="xl6516718 sumCell data" width=27 style='border-top:none;border-left:none;width:20pt' id="line${i.count-1}">${item}</td>
  </c:forEach>
  <c:if test="${empty list1}">
  	<c:forEach var="item" begin="0" end="33">
  		<td class="xl6516718 editCell" width=27 style='border-top:none;border-left:none;width:20pt'></td>
 ...
 <tr height=21 style='height:15.95pt'>
  ...
  <img width=60 height=75 src="../views/report/high/highRailSheetTwo1.files/wirelessWorkShopCir_8860_image002.png">
  </td>
 ...
 <tr class="sheetTwo" height=21 style='height:15.95pt'>
  ...
  <c:forEach items="${requestScope.list2[0]}" varStatus="i" var="item" begin="0" end="1">
  	<td colspan=3 class="xl6516718 sumCell cell data" width=81 style='border-left:none;width:60pt'>${item}</td>
  </c:forEach>
  <c:forEach items="${requestScope.list2[0]}" varStatus="i" var="item" begin="2" end="3">
  	<td colspan=3 class="xl9216718 sumCell cell data" width=81 style='border-left:none;width:60pt'>${item}</td>
  </c:forEach>
  ...
  margin-right:-1px;margin-bottom:-4px;" maxlength="250" placeholder="请输入，字数限250个"/>${requestScope.list2[0][4]}</textarea>
  </td>
 </tr>
 <tr class="sheetTwo" height=21 style='height:15.95pt'>
  <td colspan=3 height=21 class=xl6516718 width=51 style='height:15.95pt;width:39pt'>2</td>
  ...
  <c:forEach items="${requestScope.list2[1]}" varStatus="i" var="item" begin="2" end="3">
  	<td colspan=3 class="xl9216718 sumCell cell data" width=81 style='border-left:none;width:60pt'>${item}</td>
  </c:forEach>
 </tr>
 <tr class="sheetTwo" height=21 style='height:15.95pt'>
  ...
  <c:forEach items="${requestScope.list2[2]}" varStatus="i" var="item" begin="2" end="3">
  	<td colspan=3 class="xl9216718 sumCell cell data" width=81 style='border-left:none;width:60pt'>${item}</td>
  </c:forEach>
 </tr>
 <tr class="sheetTwo" height=21 style='height:15.95pt'>
  ...
  <c:forEach items="${requestScope.list2[3]}" varStatus="i" var="item" begin="2" end="3">
  	<td colspan=3 class="xl9216718 sumCell cell data" width=81 style='border-left:none;width:60pt'>${item}</td>
  </c:forEach>
 </tr>
 <tr class="sheetTwo" height=21 style='height:15.95pt'>
  ...
  <c:forEach items="${requestScope.list2[4]}" varStatus="i" var="item" begin="2" end="3">
  	<td colspan=3 class="xl9216718 sumCell cell data" width=81 style='border-left:none;width:60pt'>${item}</td>
  </c:forEach>
 </tr>
 <tr class="sheetTwo" height=21 style='height:15.95pt'>
  ...
  <c:forEach items="${requestScope.list2[5]}" varStatus="i" var="item" begin="2" end="3">
  	<td colspan=3 class="xl9216718 sumCell cell data" width=81 style='border-left:none;width:60pt'>${item}</td>
  </c:forEach>
 </tr>
 <tr class="sheetTwo" height=21 style='height:15.95pt'>
  ...
  <c:forEach items="${requestScope.list2[6]}" varStatus="i" var="item" begin="2" end="3">
  	<td colspan=3 class="xl9216718 sumCell cell data" width=81 style='border-left:none;width:60pt'>${item}</td>
  </c:forEach>
 </tr>
 <tr class="sheetTwo" height=21 style='height:15.95pt'>
  ...
  <c:forEach items="${requestScope.list2[7]}" varStatus="i" var="item" begin="2" end="3">
  	<td colspan=3 class="xl9216718 sumCell cell data" width=81 style='border-left:none;width:60pt'>${item}</td>
  </c:forEach>
 </tr>
 <tr class="sheetTwo" height=21 style='height:15.95pt'>
  ...
  <c:forEach items="${requestScope.list2[8]}" varStatus="i" var="item" begin="2" end="3">
  	<td colspan=3 class="xl9216718 sumCell cell data" width=81 style='border-left:none;width:60pt'>${item}</td>
  </c:forEach>
 </tr>
 <tr class="sheetTwo" height=21 style='height:15.95pt'>
  ...
  <c:forEach items="${requestScope.list2[9]}" varStatus="i" var="item" begin="2" end="3">
  	<td colspan=3 class="xl9216718 sumCell cell data" width=81 style='border-left:none;width:60pt'>${item}</td>
  </c:forEach>
 </tr>
 <tr class="sheetTwo" height=21 style='height:15.95pt'>
  ...
  <c:forEach items="${requestScope.list2[10]}" varStatus="i" var="item" begin="0" end="3">
  	<td colspan=3 class="xl6516718 sumCell data" width=81 style='border-left:none;width:60pt' id="lineTwo${i.count-1}">${item}</td>
  </c:forEach>
 </tr>
 <tr style='height:30px'>
  <td colspan=4 height=21 class=xl8916718 style='height:15.95pt'>单位负责人：</td>
  <td colspan=3 class="xl9116718 fillEditCell" id="personliable" style="white-space: normal;">${requestScope.list1[0][38] }</td>
  ...
  <td colspan=4 class="xl9116718 fillEditCell" id="phone" style="white-space: normal;">${requestScope.list1[0][40]}</td>
  <td class=xl7216718></td>
  <td class=xl7116718 width=27 style='width:20pt'></td>
...
function sumRowOne() {
	...
	$(".sheetOne").each(function(j) {
		...
		if(rowArray && rowArray.length != 0) {
			...
			arr[j][0] = $(rowArray[0]).html();
			arr[j][1] = $(rowArray[1]).html();
	...
	$.post(contextPath + 'highRailSheetTwoAction/add.cn',
			{
				...
				if(status){
					$("#updateForm").attr("action", "/kunmingrinms/highRailSheetTwoAction/exportShow.cn");
					$("#updateForm").submit();
				}else{
					alert("保存失败!");
				}
