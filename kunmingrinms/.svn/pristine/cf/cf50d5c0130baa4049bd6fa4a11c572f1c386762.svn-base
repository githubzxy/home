...
<title>秋鉴处</title>
  ...
  <body class="bodypadding">
  	<input type="hidden" id="orgType" name="orgType" value="chu" readonly="readonly" />
  	<div>
  		<fieldset>
			<legend>处单项质量分析表数据查询</legend>
			<div>
	...
	<script type="text/javascript" src="<%=contextPath%>/resource/js/autumn/autumnChu.js"></script>
</html>