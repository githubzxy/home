...
<!--                     </li> -->
        ...
        <div class="big-table">
			<div class="module_title">
				<span class="title"><a href="<%=contextPath%>/index.jsp">首页</a>/技术规章</span>
...
BUI.use(['bui/calendar','bui/list','bui/data','bui/toolbar'],function(Calendar,List,Data,Toolbar){
	...
	var listTpl = '<li>[{createStartDate}]<a href="'+contextPath+'homeAction/showTecrule.cn?id={id}" target="_self">{fileName}</a></li>';
	store = new Data.Store({
		url: contextPath+'homeAction/getHomeTecruleList.cn',
		proxy : {
			method : 'post',
			dataType : 'json'
		},
