...
<body>
	...
	<div class="autumn_table_div">
		<!-- 表格1 -->
		<span class="autumn_table_title">灾害监测设备年度质量分析汇总表</span>
		...
		<table id="table1" class="autumn_table autumn_table_background">
			<thead>
				<tr>
					...
					<td colspan="1">年度：</td>
					<td colspan="1" class="left"><span id="year">${param.yearNum}</span>
					</td>
				</tr>
				<tr>
...
<script type="text/javascript" src="../../resource/js/autumn/report_4_disaster_search.js"></script>
</html>
