...
<title>新增通信设备月度生产计划（完成）及质量报告表</title>
<style>
<!--table
.font527801
	{color:windowtext;
...
<table border=0 cellpadding=0 cellspacing=0 style='border-collapse:
 ...
 <tr height=18 style='height:13.5pt'>
  ...
  width:40pt'></td>
  <td class="xl6927801 editRow numberCell" width=69 style='border-top:none;border-left:none;
  width:52pt'></td>
  <td class="xl6927801 editRow numberCell" width=53 style='border-top:none;border-left:none;
  width:40pt'></td>
 ...
 <tr style='height:30px'>
  <td class=xl1527801 style='height:30px;line-height: 30px;'>单位负责人：
	<span class="fillEditCell" id="principal" style="width: 90px;height:30px;
		display:-moz-inline-box;display:inline-block;"></span></td>
  ...
  <td colspan=2 class="xl7527801 fillEditCell" id="phone"></td>
  <td class=xl1527801></td>
 </tr>
</table>
</div>
	...
	$("tr").each(function(j) {
		...
		if(rowArray && rowArray.length != 0) {
			...
			if(parseInt($(rowArray[2]).text())<=parseInt($(rowArray[1]).text())&&$(rowArray[1]).text()!=0){
				...
				$(rowArray[3]).html((100.00 - result).toFixed(2) + "%");// 合格比合格比(100-不合格比)
			}
			// 不合格数(本月完成数-合格数)
