define('views/safeSystem/FileManagementDetails',[
		...
		_initShowData:function(){
			...
			$.ajax({
				...
				success : function(result){
					...
					var fileType = "";
					if(result.fileType=="3110109") fileType = "安全规章";
				...
				formChildrens:[
					{
						label: '规章制度名称',
						itemColspan : 2, 
						item : '<input type="text" id="fileNameShow" style="width:99.5%;" readOnly="readOnly"/>'
					},{
						label: '规章制度类型',
						itemColspan : 2, 
...
//					},
					{
						label: '附件：',
						itemColspan: 2,
						item: '<div id="filesShow" style="overflow-y:auto;height:100px;" readOnly="readOnly"/>'
					},{
						label: '备注：',
						itemColspan : 2,
