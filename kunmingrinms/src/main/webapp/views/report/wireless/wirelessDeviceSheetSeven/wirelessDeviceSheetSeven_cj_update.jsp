...
<table border=0 cellpadding=0 cellspacing=0 width=1500 class=xl978944
 ...
 <tr height=20 style='height:15.0pt' class="trClass">
  ...
  <td class="xl1008944 editCell"  style='border-top:none;border-left:none;'>${item.date }</td>
  <td class="xl1008944 editCell"  style='border-top:none;border-left:none;'>${item.engineType }</td>
  <td class="xl1008944 editCell"  style='border-top:none;border-left:none;'>${item.engineNum }</td>
  <td class="xl1008944 editCell"  style='border-top:none;border-left:none;'>${item.type }</td>
  <td class="xl1008944 editCell"  style='border-top:none;border-left:none;'>${item.faultPhenomenon }</td>
  <td class="xl1018944 editCell numberCell"  style='border-top:none;border-left:none'>${item.radioHost }</td>
  <td class="xl1018944 editCell numberCell"  style='border-top:none;border-left:none'>${item.controlBox }</td>
  <td class="xl1018944 editCell numberCell"  style='border-top:none;border-left:none'>${item.mike }</td>
  <td class="xl1018944 editCell numberCell"  style='border-top:none;border-left:none'>${item.speaker }</td>
  <td class="xl1018944 editCell numberCell"  style='border-top:none;border-left:none'>${item.aerial }</td>
  <td class="xl1018944 editCell numberCell"  style='border-top:none;border-left:none'>${item.controlCable }</td>
  <td class="xl1018944 editCell numberCell"  style='border-top:none;border-left:none'>${item.testWell }</td>
  <td class="xl1008944 editCell"  style='border-top:none;border-left:none;'>${item.testFixNote }</td>
  <td class="xl1008944 editCell"  style='border-top:none;border-left:none;'>${item.remark }</td>
  <td class="xl1008944" style='border-top:none;border-left:none'>
 ...
 <tr height=20 style='height:15.0pt' id="total">
  ...
  <c:forEach items="${sumResult}" var="item" varStatus="s">
  	<td class="xl1018944 sum${s.count}" style='border-top:none;border-left:none'>${item }</td>
  </c:forEach>
  <td class="xl1018944" style='border-top:none;border-left:none'></td>
  <td class="xl1018944" style='border-top:none;border-left:none'></td>
...
<!--   	<a class="sumRow" href="#" id="sum">计算合计</a> -->
 ...
 <tr height=20 style='height:15.0pt'>
  ...
  <td colspan=2 class="xl1068944 fillEditCell" id="reporter">${requestScope.list[0].userId }</td>
		...
		$.post(contextPath + 'wirelessDeviceSheetSevenAction/add.cn',
				{
					...
					if(status){
						$("#updateForm").attr("action", "/kunmingrinms/wirelessDeviceSheetSevenAction/exportShow.cn");
						$("#updateForm").submit();
					}else{
						alert("导出失败!");
					}
