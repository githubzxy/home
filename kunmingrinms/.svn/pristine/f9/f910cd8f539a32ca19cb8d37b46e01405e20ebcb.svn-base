 ...
 * 修改人：yangsy
 * 修改时间：2019-05-30 下午4:22:00
 */

public class SparePartShowDTO implements Serializable {
...
//	}
	...
	public String toString() {
		return "SparePartShowDTO [id=" + id + ", speciality=" + speciality + ", sparePartName=" + sparePartName
				...
				+ checkStatus + ", checkUser=" + checkUser + ", checkDate=" + checkDate + ", comment=" + comment + "]";
	}
