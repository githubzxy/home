				...
				<legend>报表基本信息填写</legend>
				  <table  width="100%" border="0" cellpadding="0" cellspacing="0" >
				  	<tr>
						...
						<td width="20%"><span id="belongOrg">${sessionScope.user.organization.name}</span></td>
						<td width="20%" height="30" align="right">年度：</td>
						<td width="20%"><span id="fileYear">${param.year}</span></td>
					</tr>
					<tr>
						<td width="20%" align="right">单位负责人：</td>
						<td width="20%">
							<div>
								<input id="orgDutyUser"  type="text"  data-rules="{maxlength:100}" />
							</div>
						</td>
						<td width="20%" height="30" align="right">填报人：</td>
						<td width="20%"><span id="baseFileUser">${sessionScope.user.name}</span></td>
					</tr>
					<tr>
						<td width="20%" height="30" align="right">填报时间：</td>
						<td width="20%"><span id="baseFileDate"><jsp:include page="../common_page/ServerDate.jsp" flush="true"/></span></td>
					</tr>
				  </table>
			  </fieldset>
			</form>
