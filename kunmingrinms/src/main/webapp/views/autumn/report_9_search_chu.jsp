...
<title>通信设备（线路）质量提高计划统计表</title>
  ...
  <body>
  	 	<input id="orgId" type="hidden" value="chu" /><!-- 数据库中的id直接为chu -->
	  	 	...
	  	 	<table id="table1" class="autumn_table autumn_table_background"  >
	  	 		<thead>
	  	 			<tr>
		  	 			...
		  	 			<td colspan="9" class="left"><span id="orgNameShow" >昆明通信段</span></td>
		  	 			<td colspan="1">年度：</td>
	...
	<script type="text/javascript" src="<%=contextPath%>/resource/js/autumn/report_9_search_chu.js"></script>
</html>
