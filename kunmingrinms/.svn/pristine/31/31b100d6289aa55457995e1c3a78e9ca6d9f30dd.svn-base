				...
				<tbody>	
		            <tr class="thTdPadding">
		            	...
		            	<td>
		           		...
		           		<td>
							<div>
								<select  id="taskLevelEdit" style="width:100%;height:30px" data-rules="{sele:''}">
			            			<option value="">请选择</option>
			            		</select>
							</div>
						</td>
...
<script type="text/javascript">
	...
	$(document).ready(function () {
		/**初始化下拉选*/	
		taskManage_taskType.listData("#taskTypeEdit");//初始化任务类别下拉选
		taskManage_taskLevel.listData("#taskLevelEdit");//初始化紧急程度下拉选
		/**初始化弹出框*/
...
// 				console.log(data);
				...
				$("#taskLevelEdit").val(data.taskLevel);
