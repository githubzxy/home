...
<!-- 		            </tr> -->
		            ...
		            <tr class="thTdPadding">
	            		...
	            		<td>
	            			<div>
			            		<input type="text" name="sparePartName" id="sparePartNameScrap"  style="width:96%;height:30px" disabled="disabled">
	            			</div>
		            	</td>
	           			<th>所属工区</th>
	            		<td>
...
<!-- 		            	<td> -->
<!-- 			            	<div> -->
<!-- 			            		<input type="text" name="purchaseTimeScrap" id="purchaseTimeScrap" style="width:96%;height:30px" disabled="disabled"> -->
<!-- 			            	</div> -->
<!-- 		            	</td> -->
		            	<th>入库时间</th>
		            	<td colspan="3">
			            	<div>
			            		<input type="text" name="putInTimeScrap" id="putInTimeScrap" style="width:98%;height:30px" disabled="disabled">
			            	</div>
		            	</td>
	          		</tr>
<!-- 	          		<tr class="thTdPadding"> -->
...
<!-- 	           			<td colspan="3"> -->
<!-- 			            	<div> -->
<!-- 			            		<input type="text" name="purchaseReasonScrap" id="purchaseReasonScrap"  style="width:98%;height:30px" disabled="disabled"> -->
<!-- 			            	</div> -->
<!-- 		            	</td> -->
<!-- 		            </tr> -->
	          		<tr class="thTdPadding">
	          			<th>软件版本</th>
	           			<td colspan="3">
			            	<div>
			            		<input type="text" name="softwareVersionScrap" id="softwareVersionScrap"  style="width:98%;height:30px" disabled="disabled">
			            	</div>
		            	</td>
	          		</tr>
		            <tr class="thTdPadding">
		            	...
		            	<td colspan="3">
		            		<div>
		            			<textarea name="reason" id="reasonScrap" style="width:98%;height:130px;" data-rules="{maxlength:200}"></textarea>
		            		</div>
		            	</td>
	          		</tr>
				</tbody>
...
// 		$("#specialityScrap").val(emergency_speciality.typeName(result.speciality));
		$("#specialityScrap").val(emergency_speciality_type.typeName(result.speciality));
// 		$("#sparePartNameScrap").val(result.sparePartName.name);
		$("#sparePartNameScrap").val(result.platesName);
...
// 		$("#unitScrap").val(emergency_unit.typeName(result.sparePartName.unit));
