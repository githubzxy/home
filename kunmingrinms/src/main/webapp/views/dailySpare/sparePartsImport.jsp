...
<body style="overflow: hidden;">
	<div id="content">
		<form class="form-horizontal" id="uploadForm"action="/kunmingrinms/dailySpare/sparePartAction/importData.cn" method="post" enctype="multipart/form-data">
		            ...
		            <tr class="thTdPadding">
		            	...
		            	<td colspan="3">
	            			<div>
	            				...
	            				<span id="infor"><s>注：请按日常备品管理模板导入,只能导入excel文件</s></span>
	            			</div>
		            	</td>
	          		</tr>
	          		<tr class="thTdPadding">
...
<script type="text/javascript">
	...
	$("#downLoad").on('click',function(){
		window.location.href = contextPath+'Template/spareParts/sparePartsEmergency_Template.xls';
	});
