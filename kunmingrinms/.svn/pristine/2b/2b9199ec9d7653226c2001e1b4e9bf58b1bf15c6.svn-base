...
<!--                     </li> -->
        ...
        <div class="big-table">
			<div class="module_title">
				<span class="title"><a href="<%=contextPath%>/index.jsp">首页</a>/施工协议</span>
...
BUI.use(['bui/calendar','bui/list','bui/data','bui/toolbar'],function(Calendar,List,Data,Toolbar){
	...
	var listTpl = '<li>[{createDate}]<a href="'+contextPath+'homeAction/showWorkcrule.cn?id={docId}" target="_self">{proName}</a></li>';
	store = new Data.Store({
		url: contextPath+'homeAction/getHomeWorkruleList.cn',
		proxy : {
			method : 'post',
			dataType : 'json'
		},
