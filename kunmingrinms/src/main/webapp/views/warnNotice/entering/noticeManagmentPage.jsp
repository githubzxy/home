...
<script type="text/javascript">
	...
	seajs.use("views/warnNotice/entering/NoticeManagmentPage",function(NoticeManagmentPage){
		var noticeManagmentPage = new NoticeManagmentPage({
			contextPath : contextPath,
			perId : perId,
			orgName : orgName,
			orgId : orgId,
		});
		noticeManagmentPage.render();
	})
</script>
</body>
</html>